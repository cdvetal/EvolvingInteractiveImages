...
vec3 generateRGB(float x, float y){
    float r = audio(bri(audio(audio(audio(x,externalVal),externalVal),audio(audio(x,y),bri(externalVal,y))),bri(audio(audio(x,x),y),y)),externalVal);
    float g = audio(audio(externalVal,externalVal),bri(x,audio(bri(bri(bri(x,externalVal),y),externalVal),x)));
    float b = audio(audio(audio(x,y),audio(externalVal,y)),audio(x,bri(audio(y,y),externalVal)));
    return vec3(r,g,b);
}
