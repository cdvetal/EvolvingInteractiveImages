...
vec3 generateRGB(float x, float y){
    float r = bri(bri((bri(x,((y-(audio((externalVal+bri(x,x)),y)*((x-x)+x)))*x))-audio((y+audio(((x-y)+(y*x)),(y/(externalVal*y)))),y)),(y/externalVal)),((x+bri(audio(x,bri((((externalVal-(bri(((externalVal*y)-bri((externalVal/(bri(x,x)+y)),audio(x,(y+(externalVal-(externalVal-y)))))),externalVal)+x))-((x-externalVal)+externalVal))-(externalVal/y)),externalVal)),y))/x));
    float g = (bri(bri(externalVal,bri((y*y),(externalVal*x))),(externalVal/audio((audio(x,y)/y),audio(bri(externalVal,y),((bri(((externalVal*x)-externalVal),externalVal)/externalVal)-(((externalVal*(y-x))-((x/externalVal)-x))+y))))))/x);
    float b = (y+y);
    return vec3(r,g,b);
}
