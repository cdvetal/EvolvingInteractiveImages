...
vec3 generateRGB(float x, float y){
    float r = bri(externalVal,audio(bri(audio(bri(y,bri(y,bri(bri(externalVal,externalVal),audio(x,x)))),x),y),audio(audio(bri(audio(externalVal,x),externalVal),externalVal),bri(audio(x,bri(audio(y,externalVal),externalVal)),audio(externalVal,x)))));
    float g = bri(audio(bri(externalVal,bri(bri(externalVal,x),y)),audio(externalVal,x)),audio(externalVal,bri(bri(y,bri(y,audio(audio(externalVal,externalVal),audio(bri(bri(y,audio(externalVal,bri(x,audio(externalVal,bri(audio(externalVal,bri(x,externalVal)),y))))),bri(externalVal,y)),y)))),externalVal)));
    float b = bri(x,x);
    return vec3(r,g,b);
}
