...
vec3 generateRGB(float x, float y){
    float r = pow(y,(x-(min(mod(externalVal,audio(audio(x,min(externalVal,max(x,audio(sin(min(externalVal,x)),externalVal)))),mod(noise(x,sin((mod(((min(min(pow(y,sin((tan(min((x*(x*externalVal)),tan(externalVal)))/(externalVal+y)))),((tan(x)/sin(pow((audio(y,tan(y))/tan(y)),externalVal)))+(externalVal/pow(x,audio(((externalVal+(audio(x,sin(pow(pow(audio(audio(max(y,mod(y,externalVal)),pow(max(externalVal,y),noise(externalVal,y))),externalVal),audio(mod(x,y),mod(mod(pow(y,y),y),tan((x*externalVal))))),y)))*x))*pow(externalVal,(externalVal*y))),externalVal))))),noise(noise(pow(sin(y),pow(y,(max(x,externalVal)+x))),y),sin(cos(x))))+x)-(x-externalVal)),x)/max((x-tan(y)),x)))),y))),externalVal)/externalVal)));
    float g = mod(y,tan(sin(audio(pow(audio(mod(externalVal,(externalVal/sin(externalVal))),audio(noise(pow((noise(sin(y),y)+max(externalVal,mod(((cos(min(x,x))+cos(audio(externalVal,audio((x+(min((tan(mod(noise((cos(y)*externalVal),sin(x)),cos((externalVal/tan(((max(y,y)-y)-noise(x,x)))))))*x),mod(sin(externalVal),max(y,audio((y+externalVal),max(mod(x,min(max(noise(x,externalVal),pow(cos((x-x)),externalVal)),(audio((min(externalVal,y)-y),sin(externalVal))+y))),y)))))/x)),pow(sin(audio(tan((x/pow(x,mod(sin(max(min(x,max(x,y)),externalVal)),(((y/externalVal)+noise((externalVal+max(y,externalVal)),externalVal))/x))))),((x*x)-sin(mod(cos(min(x,audio(y,y))),externalVal))))),noise(externalVal,min(y,sin(externalVal))))))))+y),sin(x)))),x),y),y)),audio(x,y)),x))));
