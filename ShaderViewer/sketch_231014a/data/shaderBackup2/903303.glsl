...
vec3 generateRGB(float x, float y){
    float r = (pow((((pow(externalVal,pow((y-(y+externalVal)),y))+(audio((x*(pow(x,audio(y,((externalVal+x)*y)))+x)),y)*audio(externalVal,(x-audio(y,externalVal)))))/y)+(audio(((((x*externalVal)/pow(x,(x+x)))-((y+x)+externalVal))+x),((x*externalVal)/x))+y)),y)-x);
    float g = ((audio(((externalVal*(audio((pow(x,y)/(externalVal*x)),x)+(y-x)))/x),((y-((audio((y*y),(x+y))*pow(externalVal,(x-externalVal)))*((x+externalVal)+(audio(x,externalVal)+y))))-audio(((y+x)-(audio((x+externalVal),(externalVal-externalVal))+x)),x)))/(pow((audio((y+externalVal),(externalVal*(x*y)))/externalVal),y)+pow(audio((y-externalVal),audio((((externalVal-externalVal)/externalVal)*y),x)),x)))+x);
    float b = (x+x);
    return vec3(r,g,b);
}
