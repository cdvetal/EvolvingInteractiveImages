...
vec3 generateRGB(float x, float y){
    float r = (((externalVal-externalVal)-externalVal)-externalVal);
    float g = ((y/audio(externalVal,audio(((((((externalVal+pow(((((externalVal+pow(audio(pow(x,x),(y+y)),pow((y*x),(y/externalVal))))/x)+((y*externalVal)/externalVal))-y),pow((y-y),(y/externalVal))))/x)*((y*y)/externalVal))-y)/audio(y,x))-audio(((y/y)/pow(externalVal,externalVal)),pow((pow(x,audio(externalVal,y))*x),((externalVal-((y*externalVal)/y))+externalVal)))),(pow(x,(externalVal*y))/audio((x*x),x)))))/x);
    float b = audio((pow(externalVal,audio(y,x))*x),x);
    return vec3(r,g,b);
}
