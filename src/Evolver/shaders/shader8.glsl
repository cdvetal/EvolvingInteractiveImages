...
vec3 generateRGB(float x, float y){
    float r = noise(pow(max(0.28849912,0.5402968),y),0.7123897);
    float g = noise(pow(max(externalVal,0.13047409),externalVal),x);
    float b = noise(pow(max(x,externalVal),x),0.49605107);
    return vec3(r,g,b);
}
