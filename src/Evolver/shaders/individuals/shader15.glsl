...
vec3 generateRGB(float x, float y){
    float r = sin(max(0.42986012,max(pow(externalVal,max(noise(sin(tan((y/0.48547482))),tan(externalVal)),y)),sin(0.051647663))));
    float g = sin(max(externalVal,max(pow(externalVal,max(noise(sin(tan((0.27522254/0.26444864))),tan(externalVal)),0.3571179)),sin(externalVal))));
    float b = sin(max(y,max(pow(0.6005304,max(noise(sin(tan((0.43012285/x))),tan(externalVal)),0.087091684)),sin(externalVal))));
    return vec3(r,g,b);
}
