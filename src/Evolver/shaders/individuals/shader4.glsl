...
vec3 generateRGB(float x, float y){
    float r = pow(min(tan(max(sin(cos((x/0.31770396))),x)),externalVal),0.9494822);
    float g = pow(min(tan(max(sin(cos((x/0.12040186))),y)),0.26804543),0.8754015);
    float b = pow(min(tan(max(sin(cos((y/externalVal))),y)),externalVal),x);
    return vec3(r,g,b);
}
