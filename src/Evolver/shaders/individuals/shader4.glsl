...
vec3 generateRGB(float x, float y){
    float r = sin(aul(sin(0.28046036),(sin(min(auh(tan(sin(tan(0.6716865))),x),tan(y)))-aul((aul(x,x)+(pow((pow(y,y)-x),max(max(y,0.8450033),y))*y)),((0.97297776+tan(x))-y)))));
    float g = sin(aul(sin(y),(sin(min(auh(tan(sin(tan(0.057425916))),x),tan(x)))-aul((aul(y,0.35180742)+(pow((pow(y,0.631997)-x),max(max(x,y),x))*0.13591133)),((0.33604333+tan(0.9544607))-0.62548304)))));
    float b = sin(aul(sin(x),(sin(min(auh(tan(sin(tan(0.67128))),x),tan(0.51935285)))-aul((aul(y,x)+(pow((pow(x,x)-x),max(max(y,0.69237757),0.31286696))*x)),((y+tan(x))-x)))));
    return vec3(r,g,b);
}
