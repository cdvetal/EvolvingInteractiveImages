...
vec3 generateRGB(float x, float y){
    float r = pow(y,max(y,(var(mod(0.3569187,0.61401397))/cos(0.8342825))));
    float g = pow(x,max(x,(var(mod(0.9615167,y))/cos(y))));
    float b = pow(0.64162284,max(x,(var(mod(x,y))/cos(0.21849471))));
    return vec3(r,g,b);
}
