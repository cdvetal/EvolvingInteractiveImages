...
vec3 generateRGB(float x, float y){
    float r = mod(min(tan(y),x),mod(0.034134626,(sin(tan((x/cos(pow(noise(externalVal,y),y)))))/(noise(min(max(externalVal,externalVal),sin(max((externalVal/externalVal),max(0.5367186,y)))),0.13550997)/mod(0.86807823,externalVal)))));
    float g = mod(min(tan(x),x),mod(x,(sin(tan((externalVal/cos(pow(noise(x,x),x)))))/(noise(min(max(x,0.6394789),sin(max((x/externalVal),max(y,0.5476415)))),y)/mod(externalVal,0.80893874)))));
    float b = mod(min(tan(0.6497433),y),mod(y,(sin(tan((0.8808708/cos(pow(noise(externalVal,0.8251908),externalVal)))))/(noise(min(max(0.8288326,0.7872677),sin(max((y/x),max(externalVal,y)))),y)/mod(externalVal,y)))));
    return vec3(r,g,b);
}
