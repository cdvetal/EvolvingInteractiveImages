...
vec3 generateRGB(float x, float y){
    float r = tan(pow(mod(sin(noise(cos((pow(max(externalVal,y),0.28309774)/(y/externalVal))),0.92767763)),tan(noise(noise(mod(0.65592575,x),y),min(min(tan(y),sin((0.50420165/0.34893584))),externalVal)))),0.52456737));
    float g = tan(pow(mod(sin(noise(cos((pow(max(0.10821414,0.9676416),y)/(0.98278785/x))),x)),tan(noise(noise(mod(externalVal,0.37662935),y),min(min(tan(externalVal),sin((y/0.47526622))),y)))),y));
    float b = tan(pow(mod(sin(noise(cos((pow(max(x,x),y)/(externalVal/x))),externalVal)),tan(noise(noise(mod(0.035860777,y),0.33923173),min(min(tan(0.45364237),sin((x/x))),y)))),externalVal));
    return vec3(r,g,b);
}
