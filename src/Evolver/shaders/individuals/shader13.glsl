...
vec3 generateRGB(float x, float y){
    float r = noise(noise(min(mod(mod((cos(0.7001915)/(y/tan(0.73855114))),min(0.09116602,x)),externalVal),pow(noise(y,externalVal),0.93365)),externalVal),externalVal);
    float g = noise(noise(min(mod(mod((cos(x)/(y/tan(x))),min(x,y)),externalVal),pow(noise(0.88902783,0.27693462),x)),y),externalVal);
    float b = noise(noise(min(mod(mod((cos(0.66464376)/(externalVal/tan(x))),min(y,x)),x),pow(noise(x,x),x)),y),0.8623991);
    return vec3(r,g,b);
}
