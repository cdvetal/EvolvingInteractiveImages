...
vec3 generateRGB(float x, float y){
    float r = ((sin((min(tan((min(max(y,x),x)+y)),x)/y))/y)+y);
    float g = ((sin((min(tan((min(max(y,y),x)+y)),y)/y))/x)+0.9050147);
    float b = ((sin((min(tan((min(max(0.39691097,x),y)+y)),y)/y))/x)+0.3332802);
    return vec3(r,g,b);
}
