...
vec3 generateRGB(float x, float y){
    float r = sin(mod(var(cos(tan(sin(noi(tan(mod(x,y)),noi(max(0.7110568,y),min(0.7829835,x))))))),x));
    float g = sin(mod(var(cos(tan(sin(noi(tan(mod(y,x)),noi(max(x,0.91487557),min(x,0.25963962))))))),x));
    float b = sin(mod(var(cos(tan(sin(noi(tan(mod(x,y)),noi(max(0.18176061,x),min(x,x))))))),0.7062106));
    return vec3(r,g,b);
}
