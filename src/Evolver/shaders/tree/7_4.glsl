...
vec3 generateRGB(float x, float y){
    float r = pow(cos((bri((y-x),(x+x))/0.22336185)),0.35808527);
    float g = pow(cos((bri((0.37363726-0.82732826),(y+y))/y)),0.35509014);
    float b = pow(cos((bri((x-y),(y+0.745792))/y)),0.5751838);
    return vec3(r,g,b);
}
