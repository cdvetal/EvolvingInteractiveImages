...
vec3 generateRGB(float x, float y){
    float r = pow(sin(max((y-y),pow(0.38417566,y))),aud((tan(0.4171211)/(y-0.0146791935)),(y*aul(0.9340453,x))));
    float g = pow(sin(max((x-x),pow(x,0.20811033))),aud((tan(0.49387237)/(x-x)),(y*aul(y,x))));
    float b = pow(sin(max((y-x),pow(x,x))),aud((tan(x)/(y-x)),(x*aul(x,y))));
    return vec3(r,g,b);
}
