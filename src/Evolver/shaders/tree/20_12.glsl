...
vec3 generateRGB(float x, float y){
    float r = (aul(max(0.72914445,aud(y,y)),(x/x))+min(auh(cos(x),0.6797182),x));
    float g = (aul(max(y,aud(y,y)),(y/0.07361989))+min(auh(cos(y),0.97015786),x));
    float b = (aul(max(0.7200769,aud(y,0.09702198)),(0.08259257/x))+min(auh(cos(x),0.6566107),x));
    return vec3(r,g,b);
}
