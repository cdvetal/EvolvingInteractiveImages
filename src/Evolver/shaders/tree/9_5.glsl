...
vec3 generateRGB(float x, float y){
    float r = tan(pow(sin(mod(x,0.29495198)),var(max(x,x))));
    float g = tan(pow(sin(mod(0.096696496,y)),var(max(0.63647497,y))));
    float b = tan(pow(sin(mod(x,y)),var(max(y,0.009287775))));
    return vec3(r,g,b);
}
