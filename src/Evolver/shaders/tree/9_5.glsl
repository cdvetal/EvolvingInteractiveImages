...
vec3 generateRGB(float x, float y){
    float r = mod(tan(min(y,externalVal)),(mod(externalVal,0.9471531)/x));
    float g = mod(tan(min(x,x)),(mod(y,x)/externalVal));
    float b = mod(tan(min(0.85450816,y)),(mod(x,x)/0.44696498));
    return vec3(r,g,b);
}
