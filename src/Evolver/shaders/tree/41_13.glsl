...
vec3 generateRGB(float x, float y){
    float r = (aul(pow((y/x),x),((y*y)*cos(y)))-var((cos(y)-sin(y))));
    float g = (aul(pow((y/0.6783818),x),((y*y)*cos(y)))-var((cos(y)-sin(x))));
    float b = (aul(pow((0.78142494/y),y),((x*0.5886839)*cos(0.08983505)))-var((cos(y)-sin(0.9692813))));
    return vec3(r,g,b);
}
