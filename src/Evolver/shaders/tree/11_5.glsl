...
vec3 generateRGB(float x, float y){
    float r = tan(pow(mod(sin(x),tan(y)),(tan(0.9423895)/(x/0.7699094))));
    float g = tan(pow(mod(sin(x),tan(externalVal)),(tan(externalVal)/(0.7127602/0.2880962))));
    float b = tan(pow(mod(sin(externalVal),tan(externalVal)),(tan(externalVal)/(0.62327075/y))));
    return vec3(r,g,b);
}
