...
vec3 generateRGB(float x, float y){
    float r = sin(min(auh(tan(cos(tan(0.6716865))),x),cos(y)));
    float g = sin(min(auh(tan(cos(tan(0.057425916))),x),cos(x)));
    float b = sin(min(auh(tan(cos(tan(0.88187546))),x),cos(0.51935285)));
    return vec3(r,g,b);
}
