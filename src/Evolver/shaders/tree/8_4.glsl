...
vec3 generateRGB(float x, float y){
    float r = (mod(cos(noise(max(x,x),sin(y))),y)/min(sin(mod((externalVal/y),tan(y))),(y/x)));
    float g = (mod(cos(noise(max(0.086022615,y),sin(externalVal))),externalVal)/min(sin(mod((y/x),tan(x))),(y/y)));
    float b = (mod(cos(noise(max(y,y),sin(0.16695857))),0.28230047)/min(sin(mod((y/0.73797464),tan(y))),(0.38422465/y)));
    return vec3(r,g,b);
}
