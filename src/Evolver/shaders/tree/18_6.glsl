...
vec3 generateRGB(float x, float y){
    float r = (max(min(0.6056874,0.68773127),sin(x))/tan(mod(externalVal,0.45980597)));
    float g = (max(min(y,x),sin(0.6011965))/tan(mod(externalVal,x)));
    float b = (max(min(0.93113303,0.93784237),sin(y))/tan(mod(0.21836329,x)));
    return vec3(r,g,b);
}
