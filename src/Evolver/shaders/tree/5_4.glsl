...
vec3 generateRGB(float x, float y){
    float r = pow(noise((noise(min(x,0.11608958),sin(x))/x),0.89128995),mod(tan(min(y,externalVal)),(mod(externalVal,0.9471531)/x)));
    float g = pow(noise((noise(min(0.4554093,y),sin(externalVal))/externalVal),externalVal),mod(tan(min(x,x)),(mod(y,x)/externalVal)));
    float b = pow(noise((noise(min(0.22640467,0.0067641735),sin(0.6879177))/externalVal),0.38829923),mod(tan(min(0.85450816,y)),(mod(x,x)/0.44696498)));
    return vec3(r,g,b);
}
