...
vec3 generateRGB(float x, float y){
    float r = min(noise(cos(0.047044992),cos(tan(sin(max(max(cos(x),x),x))))),pow(sin(min((tan((noise(y,0.34348655)/mod(externalVal,x)))/y),y)),externalVal));
    float g = min(noise(cos(x),cos(tan(sin(max(max(cos(externalVal),0.98638725),externalVal))))),pow(sin(min((tan((noise(x,x)/mod(0.99401903,externalVal)))/0.16790485),x)),externalVal));
    float b = min(noise(cos(y),cos(tan(sin(max(max(cos(y),externalVal),x))))),pow(sin(min((tan((noise(y,0.63412404)/mod(0.37334037,externalVal)))/x),y)),0.8518975));
    return vec3(r,g,b);
}
