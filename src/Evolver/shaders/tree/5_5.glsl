...
vec3 generateRGB(float x, float y){
    float r = noise((noise(min(x,0.11608958),sin(x))/x),0.89128995);
    float g = noise((noise(min(0.4554093,y),sin(externalVal))/externalVal),externalVal);
    float b = noise((noise(min(0.22640467,0.0067641735),sin(0.6879177))/externalVal),0.38829923);
    return vec3(r,g,b);
}
