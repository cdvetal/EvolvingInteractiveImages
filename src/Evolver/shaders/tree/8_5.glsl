...
vec3 generateRGB(float x, float y){
    float r = mod(cos(noise(max(x,x),sin(y))),y);
    float g = mod(cos(noise(max(0.086022615,y),sin(externalVal))),externalVal);
    float b = mod(cos(noise(max(y,y),sin(0.16695857))),0.28230047);
    return vec3(r,g,b);
}
