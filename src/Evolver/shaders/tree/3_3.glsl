...
vec3 generateRGB(float x, float y){
    float r = pow((((y*x)+cos(y))*(pow(x,0.8504745)*max(0.1788497,y))),0.65955395);
    float g = pow((((0.49845457*0.08704895)+cos(x))*(pow(y,x)*max(x,x))),x);
    float b = pow((((x*0.4525457)+cos(0.17920339))*(pow(x,0.5651107)*max(y,y))),x);
    return vec3(r,g,b);
}
