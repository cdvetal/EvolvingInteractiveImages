...
vec3 generateRGB(float x, float y){
    float r = ((((aul(y,cos(tan(x)))/min(x,x))+x)/auh((aul(max(0.72914445,aud(y,y)),(x/x))+min(auh(cos(x),0.6797182),x)),aud((max(x,y)/x),max(x,0.5171626))))/x);
    float g = ((((aul(0.9265069,cos(tan(y)))/min(0.11114209,0.22743258))+y)/auh((aul(max(y,aud(y,y)),(y/0.07361989))+min(auh(cos(y),0.97015786),x)),aud((max(y,0.8081435)/y),max(x,0.5570865))))/0.5640824);
    float b = ((((aul(y,cos(tan(x)))/min(x,0.29064095))+y)/auh((aul(max(0.7200769,aud(y,0.09702198)),(0.08259257/x))+min(auh(cos(x),0.6566107),x)),aud((max(x,y)/y),max(x,0.86369014))))/y);
    return vec3(r,g,b);
}
