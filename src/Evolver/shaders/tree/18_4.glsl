...
vec3 generateRGB(float x, float y){
    float r = pow(sin(mod(cos(cos(y)),0.092969656)),cos(tan(noi(0.31115842,min(y,y)))));
    float g = pow(sin(mod(cos(cos(0.62295735)),0.26060736)),cos(tan(noi(0.6847295,min(y,x)))));
    float b = pow(sin(mod(cos(cos(0.111830056)),x)),cos(tan(noi(0.30927533,min(y,x)))));
    return vec3(r,g,b);
}
