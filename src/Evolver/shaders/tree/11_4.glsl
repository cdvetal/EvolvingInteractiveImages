...
vec3 generateRGB(float x, float y){
    float r = noise(tan(pow(mod(sin(x),tan(y)),(tan(0.9423895)/(x/0.7699094)))),x);
    float g = noise(tan(pow(mod(sin(x),tan(externalVal)),(tan(externalVal)/(0.7127602/0.2880962)))),externalVal);
    float b = noise(tan(pow(mod(sin(externalVal),tan(externalVal)),(tan(externalVal)/(0.62327075/y)))),externalVal);
    return vec3(r,g,b);
}
