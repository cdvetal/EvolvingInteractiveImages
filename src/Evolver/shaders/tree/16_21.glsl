...
vec3 generateRGB(float x, float y){
    float r = max(aul(aul(var((var(0.08919067)+tan(0.9666048))),tan(auh(pow(0.9471009,0.96797293),(y+0.61074847)))),y),pow(pow(sin(max((y-y),pow(0.38417566,y))),aud((tan(0.4171211)/(y-0.0146791935)),(y*aul(0.9340453,x)))),y));
    float g = max(aul(aul(var((var(x)+tan(0.24489981))),tan(auh(pow(y,y),(x+x)))),0.13136959),pow(pow(sin(max((x-x),pow(x,0.20811033))),aud((tan(0.49387237)/(x-x)),(y*aul(y,x)))),0.8953718));
    float b = max(aul(aul(var((var(x)+tan(y))),tan(auh(pow(x,0.5503613),(x+y)))),x),pow(pow(sin(max((y-x),pow(x,x))),aud((tan(x)/(y-x)),(x*aul(x,y)))),0.52756405));
    return vec3(r,g,b);
}
