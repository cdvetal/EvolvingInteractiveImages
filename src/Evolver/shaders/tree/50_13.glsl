...
vec3 generateRGB(float x, float y){
    float r = aul(min(aud(0.9458617,min(tan(y),y)),x),cos(pow((y/y),aud(y,x))));
    float g = aul(min(aud(0.9345778,min(tan(y),x)),y),cos(pow((x/y),aud(x,x))));
    float b = aul(min(aud(x,min(tan(y),0.8250359)),y),cos(pow((x/y),aud(0.15105206,x))));
    return vec3(r,g,b);
}
