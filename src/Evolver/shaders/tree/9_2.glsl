...
vec3 generateRGB(float x, float y){
    float r = noi(pow(min(tan(pow(sin(mod(x,0.29495198)),var(max(x,x)))),sin(x)),y),y);
    float g = noi(pow(min(tan(pow(sin(mod(0.096696496,y)),var(max(0.63647497,y)))),sin(y)),x),0.042575598);
    float b = noi(pow(min(tan(pow(sin(mod(x,y)),var(max(y,0.009287775)))),sin(x)),0.45816547),x);
    return vec3(r,g,b);
}
