...
vec3 generateRGB(float x, float y){
    float r = ((pow(tan((var(y)*y)),0.8461105)+x)*pow((aul(pow((y/x),x),((y*y)*cos(y)))-var((cos(y)-sin(y)))),cos((max(y,aul(y,x))-y))));
    float g = ((pow(tan((var(y)*y)),0.9063236)+y)*pow((aul(pow((y/0.6783818),x),((y*y)*cos(y)))-var((cos(y)-sin(x)))),cos((max(x,aul(x,y))-y))));
    float b = ((pow(tan((var(y)*y)),y)+x)*pow((aul(pow((0.78142494/y),y),((x*0.5886839)*cos(0.08983505)))-var((cos(y)-sin(0.9692813)))),cos((max(x,aul(0.19207746,0.24611378))-x))));
    return vec3(r,g,b);
}
