...
vec3 generateRGB(float x, float y){
    float r = (noise(min(x,0.11608958),sin(x))/x);
    float g = (noise(min(0.4554093,y),sin(externalVal))/externalVal);
    float b = (noise(min(0.22640467,0.0067641735),sin(0.6879177))/externalVal);
    return vec3(r,g,b);
}
