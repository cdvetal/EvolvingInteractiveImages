...
vec3 generateRGB(float x, float y){
    float r = mod(mod(externalVal,noise(mod(noise(mod(x,(sin(y)/0.04638186)),0.6368984),externalVal),min(x,noise(max(y,x),externalVal)))),y);
    float g = mod(mod(x,noise(mod(noise(mod(externalVal,(sin(externalVal)/externalVal)),0.66853374),0.54879504),min(externalVal,noise(max(externalVal,x),y)))),y);
    float b = mod(mod(externalVal,noise(mod(noise(mod(x,(sin(externalVal)/externalVal)),0.8726946),externalVal),min(x,noise(max(externalVal,x),y)))),0.3064218);
    return vec3(r,g,b);
}
