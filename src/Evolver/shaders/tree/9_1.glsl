...
vec3 generateRGB(float x, float y){
    float r = pow(noi(pow(min(tan(pow(sin(mod(x,0.29495198)),var(max(x,x)))),sin(x)),y),y),pow(x,pow(y,pow(sin(mod(cos(cos(y)),0.092969656)),cos(tan(noi(0.31115842,min(y,y))))))));
    float g = pow(noi(pow(min(tan(pow(sin(mod(0.096696496,y)),var(max(0.63647497,y)))),sin(y)),x),0.042575598),pow(0.3800969,pow(x,pow(sin(mod(cos(cos(0.62295735)),0.26060736)),cos(tan(noi(0.6847295,min(y,x))))))));
    float b = pow(noi(pow(min(tan(pow(sin(mod(x,y)),var(max(y,0.009287775)))),sin(x)),0.45816547),x),pow(x,pow(0.371624,pow(sin(mod(cos(cos(0.111830056)),x)),cos(tan(noi(0.30927533,min(y,x))))))));
    return vec3(r,g,b);
}
