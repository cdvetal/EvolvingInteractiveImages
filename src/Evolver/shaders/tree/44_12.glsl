...
vec3 generateRGB(float x, float y){
    float r = max((sin(0.5173736)*x),(aul(y,x)/y));
    float g = max((sin(y)*0.661407),(aul(0.76728433,0.6151272)/0.38318083));
    float b = max((sin(y)*0.19529754),(aul(0.2540955,0.59962213)/0.40535975));
    return vec3(r,g,b);
}
