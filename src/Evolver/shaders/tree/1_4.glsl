...
vec3 generateRGB(float x, float y){
    float r = cos(sin((tan(aud(y,y))-auh((x+aud(0.224081,x)),x))));
    float g = cos(sin((tan(aud(y,x))-auh((x+aud(y,y)),0.19366449))));
    float b = cos(sin((tan(aud(y,y))-auh((x+aud(0.213032,0.733924)),y))));
    return vec3(r,g,b);
}
