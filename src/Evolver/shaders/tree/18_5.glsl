...
vec3 generateRGB(float x, float y){
    float r = min((max(min(0.6056874,0.68773127),sin(x))/tan(mod(externalVal,0.45980597))),pow(tan(sin(x)),externalVal));
    float g = min((max(min(y,x),sin(0.6011965))/tan(mod(externalVal,x))),pow(tan(sin(externalVal)),0.43670368));
    float b = min((max(min(0.93113303,0.93784237),sin(y))/tan(mod(0.21836329,x))),pow(tan(sin(x)),y));
    return vec3(r,g,b);
}
