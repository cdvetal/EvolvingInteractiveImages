...
vec3 generateRGB(float x, float y){
    float r = noi(mod(x,0.9644671),(mod(cos(mod(tan(y),var(sin(y)))),x)/noi(mod(0.06399286,0.9307051),mod(sin(var(y)),0.12217194))));
    float g = noi(mod(y,0.826174),(mod(cos(mod(tan(0.33357954),var(sin(x)))),x)/noi(mod(0.75428313,x),mod(sin(var(y)),y))));
    float b = noi(mod(x,y),(mod(cos(mod(tan(0.932375),var(sin(x)))),y)/noi(mod(y,0.26331174),mod(sin(var(y)),y))));
    return vec3(r,g,b);
}
