...
vec3 generateRGB(float x, float y){
    float r = tan(tan(min(min((pow(tan(x),max(externalVal,0.20391035))/cos(cos(y))),externalVal),cos(tan(0.11627579)))));
    float g = tan(tan(min(min((pow(tan(0.95812225),max(0.99694514,y))/cos(cos(externalVal))),y),cos(tan(externalVal)))));
    float b = tan(tan(min(min((pow(tan(x),max(y,0.8127773))/cos(cos(externalVal))),0.42415285),cos(tan(y)))));
    return vec3(r,g,b);
}
