...
vec3 generateRGB(float x, float y){
    float r = cos(mod(noise(mod(0.9047797,0.6131046),x),noise(pow(pow(x,x),tan(0.2626562)),0.5683961)));
    float g = cos(mod(noise(mod(0.76521397,y),y),noise(pow(pow(y,y),tan(0.26629233)),x)));
    float b = cos(mod(noise(mod(externalVal,externalVal),y),noise(pow(pow(externalVal,y),tan(x)),0.94273615)));
    return vec3(r,g,b);
}
