...
vec3 generateRGB(float x, float y){
    float r = (pow((pow(y,y)+x),max(max(y,0.8450033),y))*y);
    float g = (pow((pow(y,0.631997)+x),max(max(x,y),x))*0.13591133);
    float b = (pow((pow(x,x)+x),max(max(y,0.6457839),0.31286696))*x);
    return vec3(r,g,b);
}
