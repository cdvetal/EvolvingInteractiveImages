...
vec3 generateRGB(float x, float y){
    float r = mod(mod(noise(max(cos(pow(0.23344159,max(max(0.19437885,externalVal),0.24233031))),x),max(min(pow(mod(y,pow(y,externalVal)),y),(x/externalVal)),sin(tan(noise(sin(x),0.17088008))))),0.39016032),(x/y));
    float g = mod(mod(noise(max(cos(pow(externalVal,max(max(externalVal,y),y))),x),max(min(pow(mod(y,pow(0.7627158,y)),x),(x/externalVal)),sin(tan(noise(sin(externalVal),x))))),y),(0.79532385/externalVal));
    float b = mod(mod(noise(max(cos(pow(y,max(max(externalVal,0.38992858),0.6114807))),x),max(min(pow(mod(x,pow(0.95658207,y)),x),(x/0.44128466)),sin(tan(noise(sin(x),y))))),externalVal),(x/externalVal));
    return vec3(r,g,b);
}
