...
vec3 generateRGB(float x, float y){
    float r = pow((cos(var(pow(x,(x-((x+0.82465553)-y)))))+max((sin(0.5173736)*x),(aul(y,x)/y))),0.18248248);
    float g = pow((cos(var(pow(y,(0.09869617-((0.8356288+x)-0.5731449)))))+max((sin(y)*0.661407),(aul(0.76728433,0.6151272)/0.38318083))),x);
    float b = pow((cos(var(pow(0.13510416,(y-((0.95592695+0.0)-x)))))+max((sin(y)*0.19529754),(aul(0.2540955,0.59962213)/0.40535975))),x);
    return vec3(r,g,b);
}
