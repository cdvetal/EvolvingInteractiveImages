...
vec3 generateRGB(float x, float y){
    float r = sin(min(cos(cos(externalVal)),pow(externalVal,y)));
    float g = sin(min(cos(cos(0.070743084)),pow(0.9921708,x)));
    float b = sin(min(cos(cos(externalVal)),pow(0.31334662,x)));
    return vec3(r,g,b);
}
