...
vec3 generateRGB(float x, float y){
    float r = tan(noise(noise(mod(0.65592575,x),y),min(min(tan(y),sin((0.50420165/0.34893584))),externalVal)));
    float g = tan(noise(noise(mod(externalVal,0.37662935),y),min(min(tan(externalVal),sin((y/0.47526622))),y)));
    float b = tan(noise(noise(mod(0.035860777,y),0.33923173),min(min(tan(0.45364237),sin((x/x))),y)));
    return vec3(r,g,b);
}
