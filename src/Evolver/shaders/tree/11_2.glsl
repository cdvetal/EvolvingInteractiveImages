...
vec3 generateRGB(float x, float y){
    float r = pow(max(noise(tan(pow(mod(sin(x),tan(y)),(tan(0.9423895)/(x/0.7699094)))),x),pow(sin(min(cos(cos(externalVal)),pow(externalVal,y))),externalVal)),x);
    float g = pow(max(noise(tan(pow(mod(sin(x),tan(externalVal)),(tan(externalVal)/(0.7127602/0.2880962)))),externalVal),pow(sin(min(cos(cos(0.070743084)),pow(0.9921708,x))),externalVal)),0.17940235);
    float b = pow(max(noise(tan(pow(mod(sin(externalVal),tan(externalVal)),(tan(externalVal)/(0.62327075/y)))),externalVal),pow(sin(min(cos(cos(externalVal)),pow(0.31334662,x))),y)),x);
    return vec3(r,g,b);
}
