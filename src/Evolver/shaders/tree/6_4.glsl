...
vec3 generateRGB(float x, float y){
    float r = (aul(x,x)+(pow((pow(y,y)+x),max(max(y,0.8450033),y))*y));
    float g = (aul(y,0.13798559)+(pow((pow(y,0.631997)+x),max(max(x,y),x))*0.13591133));
    float b = (aul(y,x)+(pow((pow(x,x)+x),max(max(y,0.6457839),0.31286696))*x));
    return vec3(r,g,b);
}
