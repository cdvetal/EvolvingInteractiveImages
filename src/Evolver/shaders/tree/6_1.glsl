...
vec3 generateRGB(float x, float y){
    float r = noi(pow(pow((noi(mod(tan(var(y)),sin(max(y,0.40440935))),y)/0.47412282),tan(tan(var(y)))),max(tan(sin(0.02788335)),tan(0.18291038))),x);
    float g = noi(pow(pow((noi(mod(tan(var(y)),sin(max(0.107966244,x))),0.36137098)/x),tan(tan(var(y)))),max(tan(sin(y)),tan(0.47557855))),x);
    float b = noi(pow(pow((noi(mod(tan(var(x)),sin(max(0.018351316,y))),x)/0.68874764),tan(tan(var(0.13569617)))),max(tan(sin(y)),tan(0.2515179))),y);
    return vec3(r,g,b);
}
