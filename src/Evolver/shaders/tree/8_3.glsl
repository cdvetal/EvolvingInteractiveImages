...
vec3 generateRGB(float x, float y){
    float r = min((mod(cos(noise(max(x,x),sin(y))),y)/min(sin(mod((externalVal/y),tan(y))),(y/x))),pow(min(externalVal,x),y));
    float g = min((mod(cos(noise(max(0.086022615,y),sin(externalVal))),externalVal)/min(sin(mod((y/x),tan(x))),(y/y))),pow(min(externalVal,x),y));
    float b = min((mod(cos(noise(max(y,y),sin(0.16695857))),0.28230047)/min(sin(mod((y/0.73797464),tan(y))),(0.38422465/y))),pow(min(externalVal,x),y));
    return vec3(r,g,b);
}
