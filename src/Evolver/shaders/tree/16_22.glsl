...
vec3 generateRGB(float x, float y){
    float r = aul(aul(var((var(0.08919067)+tan(0.9666048))),tan(auh(pow(0.9471009,0.96797293),(y+0.61074847)))),y);
    float g = aul(aul(var((var(x)+tan(0.24489981))),tan(auh(pow(y,y),(x+x)))),0.13136959);
    float b = aul(aul(var((var(x)+tan(y))),tan(auh(pow(x,0.5503613),(x+y)))),x);
    return vec3(r,g,b);
}
