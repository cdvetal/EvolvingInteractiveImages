...
vec3 generateRGB(float x, float y){
    float r = pow(sin(min(cos(cos(externalVal)),pow(externalVal,y))),externalVal);
    float g = pow(sin(min(cos(cos(0.070743084)),pow(0.9921708,x))),externalVal);
    float b = pow(sin(min(cos(cos(externalVal)),pow(0.31334662,x))),y);
    return vec3(r,g,b);
}
