...
vec3 generateRGB(float x, float y){
    float r = ((((x-0.76762694)+y)+pow(((x+y)-0.26164466),(x-y)))*((y-bri(0.23429525,x))/(0.13057745*y)));
    float g = ((((x-y)+x)+pow(((x+0.39785385)-x),(y-0.81625897)))*((0.5224682-bri(0.33243495,y))/(x*y)));
    float b = ((((x-x)+x)+pow(((y+y)-0.40586597),(0.8243941-y)))*((0.20772421-bri(0.1725769,x))/(y*y)));
    return vec3(r,g,b);
}
