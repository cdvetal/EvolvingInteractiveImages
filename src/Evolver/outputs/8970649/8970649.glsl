...
vec3 generateRGB(float x, float y){
    float r = (tan((tan((aul(aud(sin((y/tan(x))),auh(0.22460729,0.97504556)),y)/sin(aul((cos(sin(x))*x),y))))/y))*0.0);
    float g = (tan((tan((aul(aud(sin((x/tan(y))),auh(x,y)),0.5020346)/sin(aul((cos(sin(0.39923823))*x),y))))/0.5291603))*0.9552202);
    float b = (tan((tan((aul(aud(sin((0.7693139/tan(y))),auh(0.30911154,x)),y)/sin(aul((cos(sin(y))*x),0.9527092))))/y))*x);
    return vec3(r,g,b);
}
