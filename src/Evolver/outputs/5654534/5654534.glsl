...
vec3 generateRGB(float x, float y){
    float r = div(bri(0.77732015,x),sub(max(0.08299279,sin(add(y,x))),max(x,0.28671002)));
    float g = div(bri(x,x),sub(max(0.14694214,sin(add(y,x))),max(0.41249704,y)));
    float b = div(bri(0.6767411,0.38077354),sub(max(x,sin(add(0.7411399,y))),max(x,x)));
    return vec3(r,g,b);
}
