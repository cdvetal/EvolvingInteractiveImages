...
vec3 generateRGB(float x, float y){
    float r = div(sub(x,pow(x,max(pow(0.99346423,cos(y)),tan(aud(sin(y),x))))),add(add(cos(max(x,add(y,add(x,x)))),max(x,y)),div(aud(min(pow(0.7011366,0.9429922),sin(cos(x))),y),sin(0.938653))));
    float g = div(sub(y,pow(x,max(pow(0.57240295,cos(x)),tan(aud(sin(0.2316153),x))))),add(add(cos(max(y,add(x,add(0.51929617,0.31245708)))),max(0.15739608,0.85382986)),div(aud(min(pow(x,x),sin(cos(y))),x),sin(y))));
    float b = div(sub(y,pow(y,max(pow(0.7786889,cos(y)),tan(aud(sin(0.544981),0.52866864))))),add(add(cos(max(x,add(0.93335605,add(0.89925027,y)))),max(y,x)),div(aud(min(pow(x,0.086016655),sin(cos(y))),0.86644363),sin(x))));
    return vec3(r,g,b);
}
