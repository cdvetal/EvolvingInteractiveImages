...
vec3 generateRGB(float x, float y){
    float r = mod(pow(mod(cos(y),y),mod(sin(noise(sin(var(0.6901767)),(x/noise(0.46139628,sin(min(y,0.13590467)))))),0.84956753)),0.5491918);
    float g = mod(pow(mod(cos(x),x),mod(sin(noise(sin(var(y)),(x/noise(y,sin(min(x,y)))))),x)),y);
    float b = mod(pow(mod(cos(x),x),mod(sin(noise(sin(var(y)),(x/noise(x,sin(min(x,y)))))),x)),y);
    return vec3(r,g,b);
}
