...
vec3 generateRGB(float x, float y){
    float r = ((var((auh(aul(x,y),y)*(0.7302371/sin(x))))/0.053567335)+pow(sin(((cos(x)-x)/aul(pow((0.42930427/x),min(y,0.6410316)),y))),aud(y,0.7111678)));
    float g = ((var((auh(aul(0.51601714,x),0.75723857)*(x/sin(y))))/0.26320028)+pow(sin(((cos(x)-x)/aul(pow((x/0.34171122),min(y,y)),x))),aud(0.974483,y)));
    float b = ((var((auh(aul(y,y),0.30442622)*(0.66305476/sin(x))))/0.2140287)+pow(sin(((cos(x)-y)/aul(pow((x/y),min(y,x)),0.7590038))),aud(x,x)));
    return vec3(r,g,b);
}
