...
vec3 generateRGB(float x, float y){
    float r = bri(aud((x+x),0.97576815),min(((y-pow(y,y))*(tan(x)+x)),var(y)));
    float g = bri(aud((0.22735316+y),0.6920548),min(((0.5282251-pow(y,x))*(tan(y)+0.0)),var(y)));
    float b = bri(aud((x+y),y),min(((0.85217-pow(0.63291895,x))*(tan(x)+y)),var(x)));
    return vec3(r,g,b);
}
