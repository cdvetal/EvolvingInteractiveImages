...
vec3 generateRGB(float x, float y){
    float r = div(x,sub(max(0.23752761,sin(y)),bri(x,0.3797922)));
    float g = div(x,sub(max(0.37592745,sin(x)),bri(0.41249704,y)));
    float b = div(x,sub(max(x,sin(0.23271894)),bri(x,x)));
    return vec3(r,g,b);
}
