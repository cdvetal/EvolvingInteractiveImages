...
vec3 generateRGB(float x, float y){
    float r = bri(((var(y)+x)-cos(y)),bri(((var(var(x))*y)/aud(x,y)),max(cos(0.8383148),x)));
    float g = bri(((var(y)+0.15055025)-cos(x)),bri(((var(var(0.17708789))*x)/aud(y,0.6816302)),max(cos(0.62490803),y)));
    float b = bri(((var(0.54804814)+x)-cos(x)),bri(((var(var(x))*0.9784139)/aud(x,y)),max(cos(x),x)));
    return vec3(r,g,b);
}
