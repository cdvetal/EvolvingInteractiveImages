...
vec3 generateRGB(float x, float y){
    float r = (sin((bri(bri(0.4713167,0.50701153),(pow(x,x)/x))*0.79653335))*((sin(var(bri(0.4713167,0.50701153)))/y)/x));
    float g = (sin((bri(bri(0.49727288,y),(pow(0.4351473,x)/0.9420156))*y))*((sin(var(bri(0.4271519,y)))/0.54898703)/x));
    float b = (sin((bri(bri(0.43996587,y),(pow(x,x)/0.124501325))*0.860059))*((sin(var(bri(0.21333158,y)))/y)/x));
    return vec3(r,g,b);
}
