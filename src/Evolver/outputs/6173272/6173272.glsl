...
vec3 generateRGB(float x, float y){
    float r = ((aul((aud(max(x,x),y)+(aud(pow(0.9385164,0.23804191),0.7109154)+(x*max(x,0.27918693)))),tan(y))/0.22185555)+min(((y/min(min(sin(y),pow(y,x)),y))*y),aul(y,((((y-x)-cos(0.40147966))/y)/cos(y)))));
    float g = ((aul((aud(max(0.5061722,y),0.9398954)+(aud(pow(0.53281295,y),y)+(x*max(x,y)))),tan(x))/0.28052014)+min(((y/min(min(sin(x),pow(y,y)),x))*x),aul(0.67535925,((((y-0.9985782)-cos(y))/x)/cos(0.2932511)))));
    float b = ((aul((aud(max(y,y),0.45384747)+(aud(pow(y,x),x)+(x*max(0.23731416,x)))),tan(y))/0.17750603)+min(((x/min(min(sin(y),pow(y,x)),x))*x),aul(x,((((0.053686336-x)-cos(x))/x)/cos(y)))));
    return vec3(r,g,b);
}
