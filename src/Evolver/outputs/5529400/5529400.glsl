...
vec3 generateRGB(float x, float y){
    float r = pow(cos((y-x)),aud(y,(var(var(auh(min(0.059673607,min(sin(0.1543229),x)),(min((y/x),(x/x))/aul(sin(y),auh(y,y))))))/pow((0.9266864*((x-auh(max(x,y),0.6357023))-var((0.8159761+aul(y,y))))),0.03448713))));
    float g = pow(cos((0.025814295-y)),aud(0.34772247,(var(var(auh(min(0.5798118,min(sin(0.8856257),y)),(min((y/x),(0.8238257/y))/aul(sin(y),auh(0.16034764,0.47931665))))))/pow((y*((0.57074225-auh(max(x,y),y))-var((y+aul(y,x))))),y))));
    float b = pow(cos((x-x)),aud(x,(var(var(auh(min(0.089734554,min(sin(y),x)),(min((y/y),(0.40770435/y))/aul(sin(x),auh(x,y))))))/pow((x*((y-auh(max(x,y),x))-var((0.8805728+aul(y,y))))),0.46095282))));
    return vec3(r,g,b);
}
