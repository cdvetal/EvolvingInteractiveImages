...
vec3 generateRGB(float x, float y){
    float r = mod(pow(bri((noi(y,x)+y),x),y),sin(tan((y+0.8785511))));
    float g = mod(pow(bri((noi(0.92918086,0.06313741)+y),y),y),sin(tan((x+x))));
    float b = mod(pow(bri((noi(x,x)+x),0.8428892),0.42269075),sin(tan((y+y))));
    return vec3(r,g,b);
}
