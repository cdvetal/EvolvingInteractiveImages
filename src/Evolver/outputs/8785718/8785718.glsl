...
vec3 generateRGB(float x, float y){
    float r = ((mod(x,((aul(tan(sin(tan(x))),aul(sin(sin(y)),y))-0.1681543)+0.9452507))/x)*mod(tan(bri(0.2417947,aul(aul((tan(sin(0.36078072))*(bri(y,x)+0.0)),cos(bri(x,0.87127197))),x))),(x/aul(0.81057376,tan(x)))));
    float g = ((mod(0.82256037,((aul(tan(sin(tan(y))),aul(sin(sin(x)),y))-y)+x))/y)*mod(tan(bri(x,aul(aul((tan(sin(x))*(bri(y,x)+0.47543335)),cos(bri(0.13300145,0.91763216))),x))),(y/aul(y,tan(0.5640076)))));
    float b = ((mod(0.11222702,((aul(tan(sin(tan(0.28550684))),aul(sin(sin(0.26799458)),0.15274447))-y)+0.074177384))/0.008806296)*mod(tan(bri(0.66332424,aul(aul((tan(sin(0.49373728))*(bri(y,0.32501388)+x)),cos(bri(y,x))),y))),(x/aul(0.9158476,tan(x)))));
    return vec3(r,g,b);
}
