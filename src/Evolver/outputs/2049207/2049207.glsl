...
vec3 generateRGB(float x, float y){
    float r = ((tan(y)-bri(aud(0.33376247,y),(0.31660616+y)))/sin((y*y)));
    float g = ((tan(x)-bri(aud(y,x),(0.51226044+0.32405216)))/sin((0.0015610456*0.87914014)));
    float b = ((tan(x)-bri(aud(0.24742359,x),(y+x)))/sin((0.3327309*0.28304726)));
    return vec3(r,g,b);
}
