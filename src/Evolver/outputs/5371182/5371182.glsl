...
vec3 generateRGB(float x, float y){
    float r = bri(((aud(x,pow(x,x))+x)/cos(y)),bri(((max(1.4483929E-4,tan(y))*y)/tan(x)),bri(tan(tan(y)),y)));
    float g = bri(((aud(0.37912273,pow(y,0.33292812))+0.13124388)/cos(x)),bri(((max(x,tan(y))*x)/tan(y)),bri(tan(tan(0.6223367)),y)));
    float b = bri(((aud(x,pow(y,0.9769426))+x)/cos(x)),bri(((max(0.3296274,tan(0.7814684))*0.69076324)/tan(x)),bri(tan(tan(x)),x)));
    return vec3(r,g,b);
}
