...
vec3 generateRGB(float x, float y){
    float r = ((var((auh(aul(x,y),y)*(0.7302371-sin(x))))*0.053567335)+pow(sin(((cos(x)+x)/aul(pow((y/x),pow(y,0.6410316)),y))),var(y)));
    float g = ((var((auh(aul(0.51601714,x),0.75723857)*(x-sin(y))))*0.26320028)+pow(sin(((cos(x)+x)/aul(pow((x/0.34171122),pow(y,y)),x))),var(0.974483)));
    float b = ((var((auh(aul(y,y),0.30442622)*(0.66305476-sin(x))))*0.17750603)+pow(sin(((cos(x)+y)/aul(pow((x/y),pow(y,x)),0.7590038))),var(x)));
    return vec3(r,g,b);
}
