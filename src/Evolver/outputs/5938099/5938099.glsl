...
vec3 generateRGB(float x, float y){
    float r = pow(pow(0.07691264,sin(0.0)),tan(((cos(max(x,tan((tan(tan((externalVal*externalVal)))/y))))/audio(x,cos(pow(min((min(y,sin(pow(0.74295914,x)))-sin((y*0.46298712))),x),y))))+x)));
    float g = pow(pow(externalVal,sin(y)),tan(((cos(max(x,tan((tan(tan((y*y)))/x))))/audio(0.7735114,cos(pow(min((min(0.85737824,sin(pow(y,0.095163345)))-sin((0.049635112*externalVal))),x),externalVal))))+externalVal)));
    float b = pow(pow(0.7700418,sin(externalVal)),tan(((cos(max(y,tan((tan(tan((0.6900022*externalVal)))/y))))/audio(0.67521447,cos(pow(min((min(x,sin(pow(0.14094767,y)))-sin((externalVal*externalVal))),externalVal),x))))+externalVal)));
    return vec3(r,g,b);
}
