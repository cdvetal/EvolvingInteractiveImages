...
vec3 generateRGB(float x, float y){
    float r = pow((aul(y,0.8693449)*tan(aud((aud(y,y)-((sin((x+y))/x)+(x/(y-pow(x,0.7109596))))),aud(x,max(x,tan((auh(y,x)/(0.74518263-x)))))))),sin(tan(pow(aul(sin(cos(min(cos(y),var(x)))),0.2261585),max(var(tan(aul((y*x),aul(x,x)))),0.5056334)))));
    float g = pow((aul(0.4453724,0.3218643)*tan(aud((aud(x,0.15667963)-((sin((y+y))/x)+(0.38673663/(x-pow(x,x))))),aud(0.41417813,max(y,tan((auh(y,y)/(0.7560534-0.0)))))))),sin(tan(pow(aul(sin(cos(min(cos(y),var(0.03406942)))),0.24244434),max(var(tan(aul((x*x),aul(y,y)))),0.35932243)))));
    float b = pow((aul(y,0.12108969)*tan(aud((aud(y,y)-((sin((x+0.31455737))/0.8036873)+(y/(x-pow(y,0.88030744))))),aud(y,max(y,tan((auh(x,y)/(y-x)))))))),sin(tan(pow(aul(sin(cos(min(cos(x),var(x)))),x),max(var(tan(aul((y*x),aul(y,x)))),x)))));
    return vec3(r,g,b);
}
