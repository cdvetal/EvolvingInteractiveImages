...
vec3 generateRGB(float x, float y){
    float r = ((tan((min(sin(max(y,0.94785297)),y)/(0.640245*cos((y/x)))))*0.053567335)+pow((((x+x)/max(pow((y/x),pow(y,0.84635127)),y))*y),cos(y)));
    float g = ((tan((min(sin(max(x,x)),0.87766904)/(x*cos((y/y)))))*0.3986434)+pow((((y+x)/max(pow((x/0.118420064),pow(y,y)),x))*x),cos(0.974483)));
    float b = ((tan((min(sin(max(y,0.27124366)),0.30442622)/(0.66305476*cos((x/x)))))*0.34235367)+pow((((x+y)/max(pow((x/y),pow(y,x)),0.7001915))*x),cos(x)));
    return vec3(r,g,b);
}
