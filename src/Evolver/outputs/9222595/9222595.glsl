...
vec3 generateRGB(float x, float y){
    float r = aud(aud((tan(bri(y,x))+((0.50906575/0.53097653)/x)),pow(aud(bri(y,0.15028185),y),x)),aud(y,x));
    float g = aud(aud((tan(bri(0.49224544,0.6649727))+((x/0.86869115)/0.89020836)),pow(aud(bri(x,y),x),x)),aud(x,0.3076288));
    float b = aud(aud((tan(bri(x,y))+((y/0.22326672)/y)),pow(aud(bri(x,x),0.9377555),x)),aud(y,x));
    return vec3(r,g,b);
}
