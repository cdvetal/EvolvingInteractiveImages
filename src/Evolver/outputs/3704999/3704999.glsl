...
vec3 generateRGB(float x, float y){
    float r = (y*tan((aul(x,min(auh(x,x),y))/tan(var(aul(y,y))))));
    float g = (0.2932511*tan((aul(x,min(auh(x,x),x))/tan(var(aul(x,x))))));
    float b = (y*tan((aul(x,min(auh(0.8942065,y),0.50975794))/tan(var(aul(x,0.68488395))))));
    return vec3(r,g,b);
}
