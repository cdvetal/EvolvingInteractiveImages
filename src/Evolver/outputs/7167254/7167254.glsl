...
vec3 generateRGB(float x, float y){
    float r = bri(aud((tan(bri(y,x))-(sin(0.50906575)/x)),pow(aud(bri(y,0.15028185),y),x)),aud(y,x));
    float g = bri(aud((tan(bri(0.49224544,0.6649727))-(sin(x)/0.89020836)),pow(aud(bri(x,y),x),x)),aud(x,0.3076288));
    float b = bri(aud((tan(bri(x,y))-(sin(y)/y)),pow(aud(bri(x,x),0.8216275),x)),aud(y,x));
    return vec3(r,g,b);
}
