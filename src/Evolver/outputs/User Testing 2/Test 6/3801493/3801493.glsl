...
vec3 generateRGB(float x, float y){
    float r = bri(min(var(add(y,min(sub(mod(aud(sub(y,0.31073475),add(x,x)),add(y,0.4132352)),y),max(y,mul(pow(min(y,x),y),y))))),0.69659925),bri(mul(cos(y),min(min(0.7901926,0.77584577),x)),0.8327179));
    float g = bri(min(var(add(x,min(sub(mod(aud(sub(x,y),add(x,y)),add(y,x)),0.52663803),max(y,mul(pow(min(y,x),0.4307444),y))))),y),bri(mul(cos(y),min(min(0.5021684,y),x)),x));
    float b = bri(min(var(add(0.8044853,min(sub(mod(aud(sub(0.3548813,y),add(x,y)),add(x,0.3472128)),y),max(y,mul(pow(min(x,0.30719113),0.9693253),x))))),0.42527628),bri(mul(cos(y),min(min(0.32306814,0.5759716),0.507494)),0.029471397));
    return vec3(r,g,b);
}
