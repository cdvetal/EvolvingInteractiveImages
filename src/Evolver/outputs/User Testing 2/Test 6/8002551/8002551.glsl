...
vec3 generateRGB(float x, float y){
    float r = bri(noi(tan(sub(y,max(sub(mod(max(max(x,y),add(x,x)),add(y,0.123099566)),y),noi(y,add(add(x,y),aud(add(y,pow(x,x)),x)))))),0.5008135),max(mul(sin(0.0091741085),y),0.8327179));
    float g = bri(noi(tan(sub(y,max(sub(mod(max(max(x,0.81455374),add(x,y)),add(y,x)),0.52663803),noi(y,add(add(x,y),aud(add(x,pow(x,x)),0.53515005)))))),y),max(mul(sin(y),y),x));
    float b = bri(noi(tan(sub(1.0,max(sub(mod(max(max(0.59864044,y),add(x,y)),add(y,0.796247)),y),noi(y,add(add(y,0.16730142),aud(add(0.9235432,pow(x,x)),y)))))),0.426677),max(mul(sin(y),x),0.11409092));
    return vec3(r,g,b);
}
