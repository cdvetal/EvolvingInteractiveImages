...
vec3 generateRGB(float x, float y){
    float r = bri(noi(tan(sub(x,min(div(pow(min(add(y,y),add(x,x)),add(y,0.3136537)),y),max(0.14023471,mul(0.74625564,sub(x,y)))))),0.8327179),mod(sin(div(0.2122674,x)),0.8327179));
    float g = bri(noi(tan(sub(x,min(div(pow(min(add(x,x),add(x,y)),add(y,x)),0.6195574),max(y,mul(y,sub(1.0,y)))))),x),mod(sin(div(y,0.18282938)),x));
    float b = bri(noi(tan(sub(0.9205885,min(div(pow(min(add(0.3548813,y),add(x,y)),add(y,0.3065436)),y),max(y,mul(x,sub(0.9339328,x)))))),0.20089555),mod(sin(div(x,0.6659241)),0.20089555));
    return vec3(r,g,b);
}
