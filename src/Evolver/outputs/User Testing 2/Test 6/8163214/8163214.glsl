...
vec3 generateRGB(float x, float y){
    float r = bri(mod(tan(add(y,max(mul(noi(bri(add(y,y),add(x,x)),add(y,0.3136537)),y),max(y,sub(add(x,0.5138769),var(add(y,aud(x,y)))))))),0.7968657),max(cos(div(y,x)),0.8327179));
    float g = bri(mod(tan(add(x,max(mul(noi(bri(add(x,x),add(x,y)),add(y,x)),0.36999202),max(y,sub(add(x,0.7790549),var(add(x,aud(y,y)))))))),y),max(cos(div(y,y)),x));
    float b = bri(mod(tan(add(0.8044853,max(mul(noi(bri(add(0.3548813,y),add(x,y)),add(y,0.3065436)),y),max(y,sub(add(y,0.8165486),var(add(0.8044853,aud(x,x)))))))),0.42527628),max(cos(div(x,0.92720675)),0.20089555));
    return vec3(r,g,b);
}
