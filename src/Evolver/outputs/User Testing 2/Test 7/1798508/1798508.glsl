...
vec3 generateRGB(float x, float y){
    float r = add(mod(noi(add(var(mod(max(1.0,pow(add(mod(y,x),add(x,1.0)),pow(add(x,0.6196165),bri(x,y)))),0.7547376)),var(mul(sin(div(x,bri(add(x,y),max(0.3153007,x)))),div(cos(0.114794254),y)))),x),0.5743916),0.16654634);
    float g = add(mod(noi(add(var(mod(max(x,pow(add(mod(y,y),add(0.48054767,y)),pow(add(x,0.9943092),bri(0.90192914,y)))),y)),var(mul(sin(div(x,bri(add(y,y),max(0.10344148,x)))),div(cos(y),y)))),y),y),0.20669436);
    float b = add(mod(noi(add(var(mod(max(0.9606128,pow(add(mod(x,0.9885385),add(y,0.8922787)),pow(add(x,y),bri(x,0.8534236)))),y)),var(mul(sin(div(x,bri(add(0.8858688,0.27691388),max(x,0.10845089)))),div(cos(x),y)))),0.0096542835),0.91962266),x);
    return vec3(r,g,b);
}
