...
vec3 generateRGB(float x, float y){
    float r = add(mod(0.33531094,0.7998338),noi(x,sub(x,div(var(0.046011448),y))));
    float g = add(mod(y,x),noi(x,sub(0.13262486,div(var(x),y))));
    float b = add(mod(y,x),noi(x,sub(x,div(var(0.05333042),y))));
    return vec3(r,g,b);
}
