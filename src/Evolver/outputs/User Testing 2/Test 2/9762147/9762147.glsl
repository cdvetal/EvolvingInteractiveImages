...
vec3 generateRGB(float x, float y){
    float r = sub(var(sin(add(min(aud(x,mod(y,y)),0.49001646),y))),tan(div(x,mod(div(noi(x,sin(x)),x),noi(x,sin(add(mod(bri(x,pow(y,y)),0.49001646),y)))))));
    float g = sub(var(sin(add(min(aud(y,mod(x,x)),x),y))),tan(div(0.3948009,mod(div(noi(0.4284835,sin(x)),0.106582165),noi(0.4284835,sin(add(mod(bri(0.45209527,pow(x,x)),x),y)))))));
    float b = sub(var(sin(add(min(aud(x,mod(0.68665886,y)),y),y))),tan(div(x,mod(div(noi(y,sin(0.9988005)),y),noi(x,sin(add(mod(bri(x,pow(0.94410324,y)),y),y)))))));
    return vec3(r,g,b);
}
