...
vec3 generateRGB(float x, float y){
    float r = add(bri(y,sub(x,add(max(sub(0.8905983,x),y),y))),y);
    float g = add(bri(x,sub(0.432734,add(max(sub(y,x),x),0.33547854))),x);
    float b = add(bri(x,sub(x,add(max(sub(y,x),0.19467306),0.34041357))),0.44508505);
    return vec3(r,g,b);
}
