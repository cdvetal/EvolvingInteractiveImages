...
vec3 generateRGB(float x, float y){
    float r = add(var(sin(add(mod(min(x,noi(0.03521347,y)),0.49001646),y))),tan(var(x)));
    float g = add(var(sin(add(mod(min(0.026080847,noi(x,x)),x),y))),tan(var(x)));
    float b = add(var(sin(add(mod(min(y,noi(0.68665886,y)),x),y))),tan(var(y)));
    return vec3(r,g,b);
}
