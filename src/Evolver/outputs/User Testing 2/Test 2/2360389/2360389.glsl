...
vec3 generateRGB(float x, float y){
    float r = sub(max(cos(aud(tan(var(0.46334743)),0.47484112)),y),div(sub(x,mod(sin(0.78726196),mod(x,mul(x,y)))),x));
    float g = sub(max(cos(aud(tan(var(x)),0.30225325)),y),div(sub(0.6464145,mod(sin(x),mod(0.4284835,mul(x,x)))),y));
    float b = sub(max(cos(aud(tan(var(0.032826424)),y)),x),div(sub(x,mod(sin(0.87344456),mod(y,mul(0.9988005,x)))),y));
    return vec3(r,g,b);
}
