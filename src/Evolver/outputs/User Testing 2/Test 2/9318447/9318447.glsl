...
vec3 generateRGB(float x, float y){
    float r = sub(y,tan(div(x,mod(mul(noi(x,sin(x)),x),noi(x,sin(add(pow(bri(x,pow(y,y)),0.3446548),y)))))));
    float g = sub(x,tan(div(0.3948009,mod(mul(noi(0.4284835,sin(x)),0.106582165),noi(0.4284835,sin(add(pow(bri(0.45209527,pow(x,x)),x),y)))))));
    float b = sub(x,tan(div(x,mod(mul(noi(y,sin(0.9988005)),y),noi(x,sin(add(pow(bri(x,pow(0.94410324,y)),y),y)))))));
    return vec3(r,g,b);
}
