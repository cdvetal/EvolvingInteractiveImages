...
vec3 generateRGB(float x, float y){
    float r = sub(var(y),tan(sub(x,mod(tan(0.78726196),noi(x,div(x,y))))));
    float g = sub(var(0.6047225),tan(sub(0.3948009,mod(tan(x),noi(0.4284835,div(x,x))))));
    float b = sub(var(y),tan(sub(x,mod(tan(0.62895346),noi(y,div(0.8440592,x))))));
    return vec3(r,g,b);
}
