...
vec3 generateRGB(float x, float y){
    float r = add(var(tan(min(0.5038228,mod(var(bri(0.79241705,0.91034746)),0.467695)))),tan(var(x)));
    float g = add(var(tan(min(y,mod(var(bri(y,x)),x)))),tan(var(x)));
    float b = add(var(tan(min(y,mod(var(bri(y,x)),0.24052644)))),tan(var(0.22407436)));
    return vec3(r,g,b);
}
