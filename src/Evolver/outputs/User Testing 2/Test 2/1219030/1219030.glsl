...
vec3 generateRGB(float x, float y){
    float r = sub(var(sin(add(noi(max(x,noi(0.03521347,y)),0.49001646),y))),tan(sub(x,mod(sin(0.88195944),noi(x,div(x,y))))));
    float g = sub(var(sin(add(noi(max(0.026080847,noi(x,x)),x),y))),tan(sub(0.3948009,mod(sin(x),noi(0.4284835,div(x,x))))));
    float b = sub(var(sin(add(noi(max(x,noi(0.68665886,y)),x),y))),tan(sub(x,mod(sin(0.78526926),noi(y,div(0.8440592,x))))));
    return vec3(r,g,b);
}
