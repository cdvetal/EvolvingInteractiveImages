...
vec3 generateRGB(float x, float y){
    float r = add(var(sin(var(add(y,x)))),cos(div(x,mod(cos(0.78726196),pow(x,div(x,y))))));
    float g = add(var(sin(var(add(0.42976165,0.25463557)))),cos(div(0.3948009,mod(cos(x),pow(0.4284835,div(x,x))))));
    float b = add(var(sin(var(add(0.16124082,0.3277235)))),cos(div(x,mod(cos(0.87344456),pow(y,div(0.96323204,x))))));
    return vec3(r,g,b);
}
