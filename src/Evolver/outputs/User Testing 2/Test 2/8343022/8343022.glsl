...
vec3 generateRGB(float x, float y){
    float r = sub(var(sin(add(noi(bri(x,mod(0.03521347,y)),0.49001646),y))),tan(div(x,mod(sin(0.78726196),noi(x,div(x,y))))));
    float g = sub(var(sin(add(noi(bri(0.026080847,mod(x,x)),x),y))),tan(div(0.3948009,mod(sin(x),noi(0.4284835,div(x,x))))));
    float b = sub(var(sin(add(noi(bri(x,mod(0.68665886,y)),y),y))),tan(div(x,mod(sin(0.87344456),noi(y,div(0.9988005,x))))));
    return vec3(r,g,b);
}
