...
vec3 generateRGB(float x, float y){
    float r = sub(var(sin(var(add(y,x)))),cos(div(x,mod(cos(0.78726196),noi(x,div(x,y))))));
    float g = sub(var(sin(var(add(0.42976165,0.23245144)))),cos(div(0.3948009,mod(cos(x),noi(0.4284835,div(x,x))))));
    float b = sub(var(sin(var(add(0.06705165,0.3277235)))),cos(div(x,mod(cos(0.87344456),noi(y,div(0.9988005,x))))));
    return vec3(r,g,b);
}
