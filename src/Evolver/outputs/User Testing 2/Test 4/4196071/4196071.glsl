...
vec3 generateRGB(float x, float y){
    float r = sin(var(noi(mul(y,add(sin(sub(0.4983797,max(bri(min(x,x),mod(x,y)),pow(add(x,x),mul(x,x))))),x)),min(mul(y,y),0.39165568))));
    float g = sin(var(noi(mul(y,add(sin(sub(x,max(bri(min(x,y),mod(x,x)),pow(add(x,x),mul(x,x))))),y)),min(mul(0.8761208,x),0.8891473))));
    float b = sin(var(noi(mul(y,add(sin(sub(x,max(bri(min(x,y),mod(x,0.6699128)),pow(add(x,x),mul(x,x))))),x)),min(mul(y,x),0.5896859))));
    return vec3(r,g,b);
}
