...
vec3 generateRGB(float x, float y){
    float r = min(pow(add(y,x),y),bri(mul(mod(mod(tan(y),pow(aud(add(sin(bri(x,y)),mod(mod(x,x),min(x,x))),min(div(mul(x,x),y),y)),y)),pow(tan(0.6345246),mod(aud(0.19871712,y),var(pow(tan(sub(x,x)),0.6238797))))),cos(0.5003536)),y));
    float g = min(pow(add(0.3162942,0.65381885),0.5651977),bri(mul(mod(mod(tan(y),pow(aud(add(sin(bri(0.7843194,y)),mod(mod(x,x),min(x,y))),min(div(mul(x,x),0.19999695),0.47912002)),y)),pow(tan(y),mod(aud(0.614522,x),var(pow(tan(sub(x,x)),0.74703765))))),cos(0.7958443)),0.0050673485));
    float b = min(pow(add(x,x),0.59993553),bri(mul(mod(mod(tan(x),pow(aud(add(sin(bri(0.58280873,x)),mod(mod(y,x),min(x,y))),min(div(mul(x,x),x),y)),y)),pow(tan(x),mod(aud(0.22126102,0.23931098),var(pow(tan(sub(x,x)),0.893244))))),cos(y)),y));
    return vec3(r,g,b);
}
