...
vec3 generateRGB(float x, float y){
    float r = max(min(sub(y,x),y),var(cos(var(mod(noi(aud(pow(min(x,x),x),y),sub(tan(x),x)),x)))));
    float g = max(min(sub(0.3162942,0.90358067),0.46507835),var(cos(var(mod(noi(aud(pow(min(y,x),y),x),sub(tan(x),0.5400152)),x)))));
    float b = max(min(sub(x,y),0.59993553),var(cos(var(mod(noi(aud(pow(min(y,0.06715107),x),y),sub(tan(0.14059162),y)),0.09451246)))));
    return vec3(r,g,b);
}
