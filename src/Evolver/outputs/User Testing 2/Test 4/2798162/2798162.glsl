...
vec3 generateRGB(float x, float y){
    float r = noi(sub(div(0.71009207,pow(0.1626935,pow(y,aud(0.5966673,min(cos(x),y))))),x),y);
    float g = noi(sub(div(0.09363842,pow(x,pow(x,aud(y,min(cos(x),y))))),0.54153824),x);
    float b = noi(sub(div(x,pow(x,pow(y,aud(0.9306009,min(cos(x),0.5024457))))),0.92759013),0.9845588);
    return vec3(r,g,b);
}
