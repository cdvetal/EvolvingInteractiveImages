...
vec3 generateRGB(float x, float y){
    float r = min(pow(sub(y,x),y),bri(mul(mod(mod(tan(y),pow(var(add(var(0.5030916),mod(min(x,x),min(x,x)))),y)),pow(var(0.6345246),mod(aud(0.19871712,y),tan(pow(cos(mul(x,x)),y))))),cos(0.5003536)),y));
    float g = min(pow(sub(0.61133385,0.65381885),0.5651977),bri(mul(mod(mod(tan(y),pow(var(add(var(y),mod(min(x,x),min(x,y)))),y)),pow(var(y),mod(aud(0.614522,x),tan(pow(cos(mul(x,x)),0.61133385))))),cos(0.7958443)),0.0050673485));
    float b = min(pow(sub(x,y),0.59993553),bri(mul(mod(mod(tan(x),pow(var(add(var(y),mod(min(y,x),min(x,y)))),y)),pow(var(x),mod(aud(0.22126102,0.23931098),tan(pow(cos(mul(x,x)),x))))),cos(y)),y));
    return vec3(r,g,b);
}
