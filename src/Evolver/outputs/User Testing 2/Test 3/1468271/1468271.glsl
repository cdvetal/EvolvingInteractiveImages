...
vec3 generateRGB(float x, float y){
    float r = noi(div(x,bri(0.6744511,sub(y,add(x,x)))),mul(y,max(min(bri(aud(y,cos(add(add(x,mul(y,x)),aud(max(x,0.79924655),pow(x,0.0810585))))),noi(x,mod(sub(0.8966088,mul(bri(x,0.98502874),y)),y))),min(var(noi(x,var(0.87278175))),aud(noi(pow(0.37482333,x),y),cos(add(x,sub(y,mul(x,x))))))),0.19827843)));
    float g = noi(div(y,bri(x,sub(0.42667913,add(0.42983603,x)))),mul(x,max(min(bri(aud(x,cos(add(add(y,mul(x,x)),aud(max(x,x),pow(y,x))))),noi(0.36810064,mod(sub(y,mul(bri(x,0.5002632),x)),0.42311788))),min(var(noi(y,var(0.7741313))),aud(noi(pow(y,y),x),cos(add(0.06741333,sub(y,mul(x,x))))))),0.750937)));
    float b = noi(div(0.569736,bri(x,sub(0.6585512,add(0.34944797,x)))),mul(0.7834451,max(min(bri(aud(x,cos(add(add(y,mul(x,x)),aud(max(x,0.95686054),pow(x,y))))),noi(0.010564327,mod(sub(0.25113964,mul(bri(x,y),0.27796698)),y))),min(var(noi(x,var(x))),aud(noi(pow(x,y),x),cos(add(x,sub(x,mul(x,x))))))),0.8966539)));
    return vec3(r,g,b);
}
