...
vec3 generateRGB(float x, float y){
    float r = mod(y,div(sin(mod(sin(aud(min(0.42363024,var(x)),max(x,pow(0.0068912506,cos(y))))),y)),mod(sub(0.9541702,0.84310484),div(aud(div(x,y),x),x))));
    float g = mod(y,div(sin(mod(sin(aud(min(x,var(x)),max(x,pow(x,cos(y))))),y)),mod(sub(0.50721717,y),div(aud(div(x,0.6578293),0.16025949),x))));
    float b = mod(y,div(sin(mod(sin(aud(min(y,var(0.55701494)),max(y,pow(0.9580779,cos(x))))),y)),mod(sub(y,0.91000175),div(aud(div(0.016495466,0.03601241),0.43185735),0.5226481))));
    return vec3(r,g,b);
}
