...
vec3 generateRGB(float x, float y){
    float r = bri(mul(x,max(0.82612157,y)),div(y,noi(noi(x,bri(aud(min(x,tan(1.0)),0.78141403),tan(max(pow(0.5500848,x),y)))),0.43451524)));
    float g = bri(mul(y,max(x,y)),div(x,noi(noi(0.18722796,bri(aud(min(y,tan(1.0)),x),tan(max(pow(y,y),x)))),y)));
    float b = bri(mul(0.16492414,max(x,0.09034538)),div(0.49002624,noi(noi(0.21646881,bri(aud(min(x,tan(y)),0.7685213),tan(max(pow(x,y),x)))),1.0)));
    return vec3(r,g,b);
}
