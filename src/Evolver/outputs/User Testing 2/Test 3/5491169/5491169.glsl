...
vec3 generateRGB(float x, float y){
    float r = noi(div(x,y),sub(y,bri(mod(var(bri(y,var(mul(div(x,y),aud(max(x,0.6828873),pow(x,y)))))),max(aud(mod(x,aud(0.89999247,0.96323085)),0.107875824),tan(bri(pow(0.37482333,x),y)))),y)));
    float g = noi(div(y,y),sub(x,bri(mod(var(bri(x,var(mul(div(y,0.36059356),aud(max(x,x),pow(y,y)))))),max(aud(mod(y,aud(1.0,0.53713274)),0.577662),tan(bri(pow(y,y),x)))),0.52602816)));
    float b = noi(div(y,y),sub(0.5516081,bri(mod(var(bri(x,var(mul(div(0.11315799,x),aud(max(x,0.95686054),pow(y,x)))))),max(aud(mod(x,aud(x,y)),x),tan(bri(pow(x,y),x)))),0.4961164)));
    return vec3(r,g,b);
}
