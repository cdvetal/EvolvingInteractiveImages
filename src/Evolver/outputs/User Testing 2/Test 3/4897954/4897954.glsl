...
vec3 generateRGB(float x, float y){
    float r = mod(div(x,bri(0.82612157,mul(x,add(x,x)))),div(y,max(min(max(aud(y,cos(sub(div(x,sub(y,x)),aud(max(x,0.79924655),pow(x,0.29498553))))),noi(x,pow(sub(0.8966088,sub(tan(x),y)),y))),min(var(noi(x,aud(0.87278175,0.96323085))),aud(max(pow(0.08010936,x),y),mul(add(x,mul(y,mul(x,x))),0.09196663)))),0.07441592)));
    float g = mod(div(y,bri(x,mul(y,add(0.42983603,x)))),div(x,max(min(max(aud(x,cos(sub(div(y,sub(x,x)),aud(max(x,x),pow(y,x))))),noi(0.63227963,pow(sub(y,sub(tan(x),x)),0.42311788))),min(var(noi(y,aud(0.7741313,0.53713274))),aud(max(pow(y,y),x),mul(add(0.06741333,mul(y,mul(x,x))),x)))),0.750937)));
    float b = mod(div(0.569736,bri(x,mul(0.569736,add(0.1670227,x)))),div(0.49002624,max(min(max(aud(x,cos(sub(div(y,sub(x,x)),aud(max(x,0.95686054),pow(y,y))))),noi(0.010564327,pow(sub(0.25113964,sub(tan(x),0.27796698)),y))),min(var(noi(x,aud(x,y))),aud(max(pow(x,y),x),mul(add(x,mul(x,mul(x,x))),0.6464834)))),1.0)));
    return vec3(r,g,b);
}
