...
vec3 generateRGB(float x, float y){
    float r = noi(div(x,bri(0.82612157,mul(x,add(x,x)))),mul(y,max(min(bri(aud(y,cos(sub(div(x,mul(y,x)),aud(max(x,0.79924655),pow(x,0.0810585))))),noi(x,mod(sub(0.8966088,mul(var(x),y)),y))),max(var(noi(x,aud(0.87278175,0.96323085))),aud(max(pow(0.37482333,x),y),div(add(x,mul(y,mul(x,x))),0.09196663)))),0.07441592)));
    float g = noi(div(y,bri(x,mul(y,add(0.42983603,x)))),mul(x,max(min(bri(aud(x,cos(sub(div(y,mul(x,x)),aud(max(x,x),pow(y,x))))),noi(0.63227963,mod(sub(y,mul(var(x),x)),0.42311788))),max(var(noi(y,aud(0.7741313,0.53713274))),aud(max(pow(y,y),x),div(add(0.06741333,mul(y,mul(x,x))),x)))),0.750937)));
    float b = noi(div(0.569736,bri(x,mul(0.569736,add(0.1670227,x)))),mul(0.49002624,max(min(bri(aud(x,cos(sub(div(y,mul(x,x)),aud(max(x,0.95686054),pow(y,y))))),noi(0.010564327,mod(sub(0.25113964,mul(var(x),0.27796698)),y))),max(var(noi(x,aud(x,y))),aud(max(pow(x,y),x),div(add(x,mul(x,mul(x,x))),0.6464834)))),1.0)));
    return vec3(r,g,b);
}
