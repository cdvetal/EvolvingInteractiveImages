...
vec3 generateRGB(float x, float y){
    float r = noi(div(x,bri(0.6853485,mul(y,add(x,x)))),sub(var(x),y));
    float g = noi(div(y,bri(x,mul(0.3206749,add(0.42983603,x)))),sub(var(x),x));
    float b = noi(div(0.569736,bri(x,mul(0.44990635,add(0.34944797,x)))),sub(var(x),x));
    return vec3(r,g,b);
}
