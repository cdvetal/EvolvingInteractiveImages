...
vec3 generateRGB(float x, float y){
    float r = mod(div(x,bri(0.727484,add(y,0.11493492))),add(y,y));
    float g = mod(div(y,bri(x,add(0.684268,x))),add(x,x));
    float b = mod(div(0.569736,bri(x,add(0.35743928,x))),add(0.7834451,x));
    return vec3(r,g,b);
}
