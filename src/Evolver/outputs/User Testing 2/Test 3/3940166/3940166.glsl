...
vec3 generateRGB(float x, float y){
    float r = mod(div(y,aud(0.727484,add(y,0.26316762))),add(0.084022045,y));
    float g = mod(div(y,aud(x,add(0.684268,y))),add(x,x));
    float b = mod(div(0.43963885,aud(x,add(0.35743928,y))),add(0.96230555,0.7834451));
    return vec3(r,g,b);
}
