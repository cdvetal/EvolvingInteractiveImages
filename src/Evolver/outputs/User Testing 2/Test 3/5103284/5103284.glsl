...
vec3 generateRGB(float x, float y){
    float r = mod(y,div(mul(noi(sin(var(sin(add(aud(tan(x),y),0.20716739)))),y),0.67528033),mod(add(0.668334,0.73100424),div(bri(div(x,y),x),x))));
    float g = mod(y,div(mul(noi(sin(var(sin(add(aud(tan(x),y),y)))),y),y),mod(add(0.50721717,y),div(bri(div(y,0.6578293),0.16025949),x))));
    float b = mod(y,div(mul(noi(sin(var(sin(add(aud(tan(x),x),x)))),y),x),mod(add(y,1.0),div(bri(div(0.016495466,y),0.71956444),0.5226481))));
    return vec3(r,g,b);
}
