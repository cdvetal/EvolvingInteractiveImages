...
vec3 generateRGB(float x, float y){
    float r = bri(mul(x,bri(0.82612157,div(x,sub(x,x)))),div(y,noi(noi(max(max(y,div(mul(div(x,mul(y,x)),aud(bri(x,0.65744495),pow(x,0.22697854))),y)),max(x,pow(sub(0.86046696,div(tan(x),y)),y))),bri(var(noi(x,var(1.0))),tan(max(pow(0.45370173,x),y)))),0.2754836)));
    float g = bri(mul(y,bri(x,div(y,sub(0.18722796,x)))),div(x,noi(noi(max(max(x,div(mul(div(y,mul(x,x)),aud(bri(x,x),pow(y,x))),x)),max(0.33715963,pow(sub(y,div(tan(x),x)),0.2933421))),bri(var(noi(y,var(0.7741313))),tan(max(pow(y,y),x)))),y)));
    float b = bri(mul(y,bri(x,div(0.90532064,sub(0.009829521,x)))),div(0.49002624,noi(noi(max(max(y,div(mul(div(0.24261212,mul(x,x)),aud(bri(x,0.84637976),pow(y,y))),0.7592468)),max(0.010564327,pow(sub(0.13160372,div(tan(x),0.27796698)),y))),bri(var(noi(x,var(y))),tan(max(pow(x,y),x)))),1.0)));
    return vec3(r,g,b);
}
