...
vec3 generateRGB(float x, float y){
    float r = mod(div(x,max(pow(sin(x),add(0.06917882,y)),sub(y,var(sin(x))))),add(y,y));
    float g = mod(div(y,max(pow(sin(0.23741674),add(x,y)),sub(0.74198914,var(sin(x))))),add(x,x));
    float b = mod(div(0.44203806,max(pow(sin(y),add(0.8198559,0.6107538)),sub(0.539464,var(sin(x))))),add(0.7834451,x));
    return vec3(r,g,b);
}
