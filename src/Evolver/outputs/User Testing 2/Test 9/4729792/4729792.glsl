...
vec3 generateRGB(float x, float y){
    float r = add(sub(mod(add(x,0.025647163),cos(0.6705663)),min(y,0.1331389)),noi(aud(0.33574533,x),div(div(bri(x,var(y)),y),y)));
    float g = add(sub(mod(add(0.753654,0.5596318),cos(x)),min(0.39102888,0.72210574)),noi(aud(y,x),div(div(bri(y,var(x)),0.7350235),y)));
    float b = add(sub(mod(add(x,0.25715852),cos(0.63348293)),min(x,0.9919679)),noi(aud(0.84537745,0.67427063),div(div(bri(0.68373966,var(0.4793911)),y),x)));
    return vec3(r,g,b);
}
