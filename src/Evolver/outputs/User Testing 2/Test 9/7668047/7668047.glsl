...
vec3 generateRGB(float x, float y){
    float r = bri(x,add(add(aud(0.46613836,0.84385204),add(mul(div(max(pow(x,0.69478583),min(mod(0.5303068,var(y)),x)),y),y),sin(min(add(bri(sub(tan(x),y),aud(x,0.3769195)),y),y)))),x));
    float g = bri(x,add(add(aud(0.67073154,y),add(mul(div(max(pow(0.80329657,1.0),min(mod(y,var(0.046980143)),0.60586286)),x),y),sin(min(add(bri(sub(tan(x),0.24896812),aud(x,y)),x),x)))),x));
    float b = bri(x,add(add(aud(y,0.2522366),add(mul(div(max(pow(y,x),min(mod(x,var(x)),0.8901725)),y),x),sin(min(add(bri(sub(tan(x),x),aud(0.9920156,x)),x),0.60426307)))),0.06652665));
    return vec3(r,g,b);
}
