...
vec3 generateRGB(float x, float y){
    float r = bri(y,add(sin(mod(0.3330698,aud(0.75024056,cos(mul(x,aud(0.13863349,aud(0.19221973,pow(0.049387455,x)))))))),x));
    float g = bri(0.519639,add(sin(mod(0.8593371,aud(y,cos(mul(0.9352021,aud(y,aud(y,pow(x,x)))))))),x));
    float b = bri(y,add(sin(mod(0.19539261,aud(x,cos(mul(0.09286165,aud(x,aud(x,pow(x,x)))))))),y));
    return vec3(r,g,b);
}
