...
vec3 generateRGB(float x, float y){
    float r = add(mod(div(0.4401939,x),var(var(cos(y)))),sub(div(sin(cos(cos(y))),x),y));
    float g = add(mod(div(x,x),var(var(cos(x)))),sub(div(sin(cos(cos(y))),0.737782),y));
    float b = add(mod(div(0.8532779,y),var(var(cos(0.25568843)))),sub(div(sin(cos(cos(y))),0.6559346),y));
    return vec3(r,g,b);
}
