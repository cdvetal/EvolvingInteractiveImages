...
vec3 generateRGB(float x, float y){
    float r = bri(y,add(sin(mod(0.3330698,aud(0.60988545,cos(sin(x))))),x));
    float g = bri(0.519639,add(sin(mod(0.7011843,aud(y,cos(sin(0.9352021))))),x));
    float b = bri(y,add(sin(mod(0.15560102,aud(x,cos(sin(0.09286165))))),y));
    return vec3(r,g,b);
}
