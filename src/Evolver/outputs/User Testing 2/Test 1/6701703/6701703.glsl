...
vec3 generateRGB(float x, float y){
    float r = min(cos(0.60703015),bri(mul(y,var(min(min(y,x),mod(var(add(0.1959517,0.7121973)),var(max(pow(x,y),mod(y,0.6947298))))))),tan(y)));
    float g = min(cos(x),bri(mul(x,var(min(min(y,x),mod(var(add(x,0.9402306)),var(max(pow(x,0.5679097),mod(0.08393574,y))))))),tan(y)));
    float b = min(cos(y),bri(mul(y,var(min(min(0.018879652,0.9783366),mod(var(add(y,0.96913505)),var(max(pow(0.3526945,x),mod(x,x))))))),tan(y)));
    return vec3(r,g,b);
}
