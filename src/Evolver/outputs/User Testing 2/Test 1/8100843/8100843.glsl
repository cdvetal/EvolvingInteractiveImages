...
vec3 generateRGB(float x, float y){
    float r = bri(y,add(div(mod(0.3330698,aud(0.7899051,sin(mul(x,aud(0.13863349,x))))),x),x));
    float g = bri(0.519639,add(div(mod(0.8593371,aud(y,sin(mul(0.9352021,aud(y,x))))),x),x));
    float b = bri(y,add(div(mod(0.19539261,aud(x,sin(mul(0.09286165,aud(x,x))))),y),y));
    return vec3(r,g,b);
}
