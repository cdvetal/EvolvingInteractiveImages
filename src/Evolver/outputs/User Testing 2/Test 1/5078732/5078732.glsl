...
vec3 generateRGB(float x, float y){
    float r = bri(sin(aud(x,y)),pow(min(x,x),var(add(0.20203853,bri(x,bri(mul(mul(bri(y,bri(x,x)),x),x),mod(mod(noi(max(y,x),noi(x,x)),noi(add(x,x),cos(x))),bri(sin(mul(x,0.0077695847)),y))))))));
    float g = bri(sin(aud(x,0.752619)),pow(min(x,x),var(add(0.29145575,bri(0.54005885,bri(mul(mul(bri(y,bri(x,x)),0.5075488),x),mod(mod(noi(max(0.056964397,x),noi(x,x)),noi(add(x,x),cos(x))),bri(sin(mul(x,y)),x))))))));
    float b = bri(sin(aud(y,y)),pow(min(0.6529045,x),var(add(y,bri(0.3853855,bri(mul(mul(bri(0.085256815,bri(x,x)),y),x),mod(mod(noi(max(y,x),noi(x,x)),noi(add(x,x),cos(x))),bri(sin(mul(x,x)),y))))))));
    return vec3(r,g,b);
}
