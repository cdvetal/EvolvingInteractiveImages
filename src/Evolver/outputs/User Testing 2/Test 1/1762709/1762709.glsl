...
// Generation: 0
// Population Size: 18; Elite Size: 1; Mutation Rate: 0.4; Crossover Rate: 0.3; Tournament Size: 1
############################ */
...
vec3 generateRGB(float x, float y){
    float r = mod(min(mul(bri(max(x,mod(pow(y,sin(x)),y)),0.33177137),add(div(x,mul(x,min(y,bri(y,pow(x,0.81903577))))),bri(noi(cos(div(y,x)),max(0.25286865,x)),x))),0.9429674),x);
    float g = mod(min(mul(bri(max(y,mod(pow(x,sin(x)),y)),0.7740197),add(div(0.98900414,mul(x,min(x,bri(y,pow(y,y))))),bri(noi(cos(div(x,0.87420416)),max(y,0.97054195)),x))),x),0.07519603);
    float b = mod(min(mul(bri(max(y,mod(pow(0.8881049,sin(y)),y)),x),add(div(x,mul(0.3421669,min(x,bri(y,pow(x,0.21409822))))),bri(noi(cos(div(0.5807507,y)),max(0.6388869,y)),0.6031208))),0.54561687),x);
    return vec3(r,g,b);
}
