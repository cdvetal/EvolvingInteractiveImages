...
vec3 generateRGB(float x, float y){
    float r = bri(cos(bri(x,y)),pow(noi(x,x),var(add(x,bri(y,noi(x,x))))));
    float g = bri(cos(bri(x,0.519639)),pow(noi(x,x),var(add(x,bri(0.24313879,noi(x,0.4639659))))));
    float b = bri(cos(bri(y,y)),pow(noi(0.6529045,x),var(add(y,bri(0.7225599,noi(0.75484276,0.014454126))))));
    return vec3(r,g,b);
}
