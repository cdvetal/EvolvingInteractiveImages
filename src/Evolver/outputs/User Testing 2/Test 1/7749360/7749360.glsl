...
vec3 generateRGB(float x, float y){
    float r = bri(tan(y),add(mul(y,noi(bri(tan(aud(x,mul(x,sub(div(y,x),0.79460645)))),min(0.55920815,y)),cos(0.8188219))),x));
    float g = bri(tan(y),add(mul(x,noi(bri(tan(aud(y,mul(x,sub(div(0.8201432,x),0.46614504)))),min(x,y)),cos(x))),x));
    float b = bri(tan(y),add(mul(x,noi(bri(tan(aud(y,mul(x,sub(div(x,x),y)))),min(y,x)),cos(0.70468974))),y));
    return vec3(r,g,b);
}
