...
vec3 generateRGB(float x, float y){
    float r = bri(tan(y),sub(mul(y,min(aud(tan(var(x)),min(0.55920815,y)),cos(mul(y,0.6634078)))),y));
    float g = bri(tan(y),sub(mul(x,min(aud(tan(var(y)),min(y,y)),cos(mul(0.519639,0.004102707)))),x));
    float b = bri(tan(y),sub(mul(x,min(aud(tan(var(y)),min(0.14142132,x)),cos(mul(y,0.13222075)))),y));
    return vec3(r,g,b);
}
