...
vec3 generateRGB(float x, float y){
    float r = var(bri(x,mod(mul(0.9219706,pow(var(min(y,y)),bri(mul(y,x),0.02066946))),bri(x,pow(div(0.4156015,y),cos(min(y,var(0.62451243))))))));
    float g = var(bri(0.9494395,mod(mul(x,pow(var(min(y,0.7784748)),bri(mul(y,y),y))),bri(0.4272976,pow(div(0.9712491,x),cos(min(0.009471655,var(x))))))));
    float b = var(bri(0.60589314,mod(mul(y,pow(var(min(x,x)),bri(mul(0.10712147,0.97248054),0.79278326))),bri(y,pow(div(0.03748536,0.41012168),cos(min(0.91356325,var(0.44498706))))))));
    return vec3(r,g,b);
}
