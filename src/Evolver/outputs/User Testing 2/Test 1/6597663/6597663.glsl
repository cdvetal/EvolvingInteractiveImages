...
vec3 generateRGB(float x, float y){
    float r = bri(y,add(sin(noi(0.3330698,bri(0.75024056,cos(div(x,aud(0.13863349,aud(0.19221973,pow(0.049387455,x)))))))),x));
    float g = bri(0.519639,add(sin(noi(0.8593371,bri(y,cos(div(0.9352021,aud(y,aud(y,pow(x,x)))))))),x));
    float b = bri(y,add(sin(noi(0.19539261,bri(x,cos(div(0.09286165,aud(x,aud(x,pow(x,x)))))))),y));
    return vec3(r,g,b);
}
