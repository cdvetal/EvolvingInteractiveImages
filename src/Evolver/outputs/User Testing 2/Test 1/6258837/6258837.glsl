...
vec3 generateRGB(float x, float y){
    float r = bri(tan(div(x,pow(div(pow(x,mul(x,y)),0.7093611),pow(x,div(0.034783125,0.6725416))))),x);
    float g = bri(tan(div(x,pow(div(pow(y,mul(x,y)),x),pow(0.6757393,div(x,0.7381816))))),x);
    float b = bri(tan(div(y,pow(div(pow(x,mul(x,y)),0.6157925),pow(x,div(x,x))))),x);
    return vec3(r,g,b);
}
