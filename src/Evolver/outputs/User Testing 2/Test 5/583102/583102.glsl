...
vec3 generateRGB(float x, float y){
    float r = pow(aud(0.6770158,mod(var(bri(0.049483776,x)),noi(y,x))),pow(aud(noi(noi(sin(0.5401349),pow(min(x,aud(x,min(x,aud(y,y)))),mul(x,tan(x)))),x),x),x));
    float g = pow(aud(x,mod(var(bri(0.26524615,x)),noi(x,x))),pow(aud(noi(noi(sin(x),pow(min(x,aud(x,min(x,aud(0.21715307,0.88318205)))),mul(y,tan(y)))),y),y),y));
    float b = pow(aud(x,mod(var(bri(y,x)),noi(0.08654213,x))),pow(aud(noi(noi(sin(x),pow(min(y,aud(x,min(0.100562096,aud(y,x)))),mul(x,tan(0.76877546)))),x),0.77286243),x));
    return vec3(r,g,b);
}
