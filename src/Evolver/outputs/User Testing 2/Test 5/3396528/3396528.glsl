...
vec3 generateRGB(float x, float y){
    float r = pow(max(var(y),mod(var(aud(0.049483776,x)),pow(y,y))),pow(var(noi(noi(mul(0.5401349,x),pow(min(x,bri(x,min(x,var(y)))),div(x,cos(x)))),x)),x));
    float g = pow(max(var(0.7380676),mod(var(aud(0.26524615,x)),pow(x,x))),pow(var(noi(noi(mul(x,0.75688934),pow(min(x,bri(x,min(x,var(0.21715307)))),div(y,cos(y)))),y)),x));
    float b = pow(max(var(y),mod(var(aud(y,x)),pow(0.18902135,x))),pow(var(noi(noi(mul(x,x),pow(min(y,bri(x,min(0.43245482,var(y)))),div(x,cos(0.51156783)))),x)),x));
    return vec3(r,g,b);
}
