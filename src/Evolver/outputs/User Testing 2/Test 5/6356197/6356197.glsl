...
vec3 generateRGB(float x, float y){
    float r = mod(max(var(y),noi(aud(bri(0.049483776,x),x),noi(y,x))),pow(var(min(mod(div(0.5401349,x),aud(y,x)),x)),x));
    float g = mod(max(var(0.7380676),noi(aud(bri(0.26524615,x),x),noi(x,x))),pow(var(min(mod(div(x,0.75688934),aud(0.1168406,1.0)),y)),y));
    float b = mod(max(var(y),noi(aud(bri(y,x),x),noi(0.04033804,x))),pow(var(min(mod(div(x,x),aud(y,x)),x)),x));
    return vec3(r,g,b);
}
