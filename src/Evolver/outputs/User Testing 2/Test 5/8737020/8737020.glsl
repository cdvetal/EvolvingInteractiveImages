...
vec3 generateRGB(float x, float y){
    float r = mul(aud(mod(0.11460543,max(x,mod(mod(add(var(mod(0.6839051,y)),var(noi(0.30867577,0.86998796))),pow(y,0.7731495)),0.0054764748))),y),div(0.5414889,y));
    float g = mul(aud(mod(x,max(x,mod(mod(add(var(mod(x,y)),var(noi(y,0.4913466))),pow(y,0.71347666)),x))),y),div(y,0.118189335));
    float b = mul(aud(mod(0.0035977364,max(x,mod(mod(add(var(mod(x,x)),var(noi(0.83054686,x))),pow(y,x)),y))),x),div(y,x));
    return vec3(r,g,b);
}
