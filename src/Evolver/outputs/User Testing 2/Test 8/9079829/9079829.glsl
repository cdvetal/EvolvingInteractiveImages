...
vec3 generateRGB(float x, float y){
    float r = mul(y,mul(y,min(add(cos(min(sub(x,min(0.12292242,mul(bri(x,x),x))),pow(max(0.75393105,bri(min(x,y),pow(x,x))),pow(aud(var(0.32409),sin(x)),1.0)))),add(y,y)),bri(y,x))));
    float g = mul(x,mul(y,min(add(cos(min(sub(x,min(x,mul(bri(x,x),0.3516276))),pow(max(x,bri(min(x,y),pow(x,y))),pow(aud(var(0.53885365),sin(x)),y)))),add(0.6315398,x)),bri(x,0.9938934))));
    float b = mul(y,mul(y,min(add(cos(min(sub(x,min(y,mul(bri(x,x),y))),pow(max(x,bri(min(0.68637204,x),pow(x,x))),pow(aud(var(y),sin(x)),x)))),add(0.8740542,0.707016)),bri(x,y))));
    return vec3(r,g,b);
}
