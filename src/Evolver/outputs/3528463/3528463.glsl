...
vec3 generateRGB(float x, float y){
    float r = (aul(x,auh((x+y),auh(((cos(0.9400962)+cos(bri((y*x),(aud(0.21478236,x)*sin(0.0)))))+auh(var(x),(y+y))),(0.77560383+(y+y)))))-((0.6261018+0.44386357)*0.42247117));
    float g = (aul(x,auh((y+x),auh(((cos(x)+cos(bri((y*y),(aud(y,0.055861294)*sin(0.0)))))+auh(var(y),(x+y))),(x+(y+0.041777015)))))-((y+y)*x));
    float b = (aul(x,auh((0.1471948+x),auh(((cos(y)+cos(bri((0.08460063*y),(aud(x,x)*sin(0.0)))))+auh(var(y),(y+x))),(x+(y+x)))))-((0.93906+x)*0.5430123));
    return vec3(r,g,b);
}
