...
vec3 generateRGB(float x, float y){
    float r = pow(min(x,var(0.7278514)),((x-0.6258411)*sin(0.31846637)));
    float g = pow(min(y,var(x)),((x-y)*sin(x)));
    float b = pow(min(0.24331051,var(0.4770214)),((0.15533084-0.026203573)*sin(0.7930348)));
    return vec3(r,g,b);
}
