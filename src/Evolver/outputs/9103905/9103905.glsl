...
vec3 generateRGB(float x, float y){
    float r = bri(0.75940776,bri((min(0.92061067,aud(0.33025825,x))+0.23500156),(x+y)));
    float g = bri(y,bri((min(y,aud(y,0.8499241))+0.16632503),(y+0.8298939)));
    float b = bri(0.024143815,bri((min(x,aud(y,x))+x),(0.8132919+0.5487183)));
    return vec3(r,g,b);
}
