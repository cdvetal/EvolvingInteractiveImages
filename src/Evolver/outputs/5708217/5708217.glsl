...
vec3 generateRGB(float x, float y){
    float r = min(((y+(0.26466483/sin(0.5895982)))-min(y,y)),var(bri(y,y)));
    float g = min(((y+(0.9152861/sin(0.8054808)))-min(0.9081711,0.16555434)),var(bri(x,y)));
    float b = min(((y+(x/sin(0.7470612)))-min(y,y)),var(bri(y,0.13738793)));
    return vec3(r,g,b);
}
