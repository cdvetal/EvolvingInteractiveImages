...
vec3 generateRGB(float x, float y){
    float r = (aul(auh(x,x),(sin(min(auh(cos((cos(0.863934)/y)),x),cos(y)))/aud((max(x,x)-(min((pow(y,y)+x),max(max(x,0.8450033),y))-y)),((0.97297776-cos(x))+y))))/0.22956137);
    float g = (aul(auh(0.80397964,x),(sin(min(auh(cos((cos(0.057425916)/y)),x),cos(x)))/aud((max(y,0.43424428)-(min((pow(y,0.7259454)+x),max(max(y,y),x))-0.27196646)),((0.33604333-cos(0.9544607))+0.62548304))))/0.8588521);
    float b = (aul(auh(y,y),(sin(min(auh(cos((cos(0.88187546)/x)),x),cos(0.45824128)))/aud((max(y,x)-(min((pow(x,x)+x),max(max(0.6846655,0.6457839),0.05177799))-x)),((y-cos(x))+x))))/0.88818777);
    return vec3(r,g,b);
}
