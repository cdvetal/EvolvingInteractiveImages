...
vec3 generateRGB(float x, float y){
    float r = bri(sin((aud(x,pow(x,(x+x)))+x)),tan(tan(var(bri(y,x)))));
    float g = bri(sin((aud(0.36422396,pow(y,(y+y)))+0.13124388)),tan(tan(var(bri(x,0.0096277)))));
    float b = bri(sin((aud(x,pow(y,(y+x)))+x)),tan(tan(var(bri(y,x)))));
    return vec3(r,g,b);
}
