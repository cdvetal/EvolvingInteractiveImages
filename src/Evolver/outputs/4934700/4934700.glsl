...
vec3 generateRGB(float x, float y){
    float r = noise(y,((audio(y,0.12602472)/(y-externalVal))/pow(mod(0.25371623,x),externalVal)));
    float g = noise(externalVal,((audio(y,0.9581348)/(y-x))/pow(mod(0.5478184,y),0.56529325)));
    float b = noise(y,((audio(x,y)/(x-y))/pow(mod(y,externalVal),x)));
    return vec3(r,g,b);
}
