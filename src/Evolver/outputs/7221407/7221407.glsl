...
vec3 generateRGB(float x, float y){
    float r = aud(y,max(((y-bri(x,y))*(tan(pow(x,0.70742637))-x)),aud(y,sin((y+0.43657073)))));
    float g = aud(0.040338457,max(((0.4083825-bri(y,x))*(tan(pow(y,x))-0.06149286)),aud(x,sin((y+0.63487315)))));
    float b = aud(x,max(((0.8702301-bri(0.65821266,x))*(tan(pow(x,y))-y)),aud(y,sin((x+0.73300606)))));
    return vec3(r,g,b);
}
