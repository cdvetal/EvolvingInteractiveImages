...
vec3 generateRGB(float x, float y){
    float r = (bri(tan((((0.34495658+x)+(x+(x+(y+x))))-(((0.9505289+x)+max(((cos(min((0.0*0.0),cos(0.0)))/y)*(bri(y,x)-x)),(min((x*(y-cos(0.26575965))),sin((0.6761214+y)))*(x+x))))+0.5011112))),tan((y-(y+y))))-cos(((((0.9793194+(y+0.29596514))+(x+y))+((0.06584644+y)+x))+((x+y)+(0.586173+x)))));
    float g = (bri(tan((((y+0.75198483)+(y+(x+(y+y))))-(((y+y)+max(((cos(min((0.0*0.0),cos(0.0)))/x)*(bri(y,0.8349125)-x)),(min((y*(y-cos(0.17890769))),sin((x+y)))*(y+0.18700325))))+x))),tan((y-(x+0.8129904))))-cos(((((0.9306888+(0.8310469+y))+(0.28506285+y))+((0.21221405+0.95011264)+x))+((y+y)+(y+x)))));
    float b = (bri(tan((((0.39879888+y)+(y+(x+(0.7296937+x))))-(((x+y)+max(((cos(min((0.0*0.0),cos(0.0)))/y)*(bri(0.7154478,0.54144233)-y)),(min((x*(0.8021105-cos(0.0))),sin((0.59353906+x)))*(0.5890839+y))))+y))),tan((x-(y+0.6775816))))-cos(((((y+(x+y))+(y+y))+((x+y)+y))+((x+y)+(0.75350386+x)))));
    return vec3(r,g,b);
}
