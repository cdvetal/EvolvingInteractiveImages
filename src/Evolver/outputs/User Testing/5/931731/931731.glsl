...
vec3 generateRGB(float x, float y){
    float r = bri(cos(pow(aud(0.029925585,min((x+0.41333055),var((0.2522934+0.044114113)))),(tan(max((x+y),(y+y)))+max(min(tan(((x+y)*bri((y+x),0.7103861))),tan((0.8993477+y))),cos((0.8493188+x)))))),x);
    float g = bri(cos(pow(aud(x,min((x+x),var((y+0.4722916)))),(tan(max((y+x),(y+y)))+max(min(tan(((0.36876744+y)*bri((y+0.91472054),x))),tan((y+0.7671164))),cos((0.19749713+y)))))),0.72081953);
    float b = bri(cos(pow(aud(y,min((x+y),var((0.67841613+x)))),(tan(max((x+0.7654905),(x+y)))+max(min(tan(((0.3896132+0.81901324)*bri((0.38362777+y),0.72725344))),tan((x+x))),cos((0.61282164+y)))))),x);
    return vec3(r,g,b);
}
