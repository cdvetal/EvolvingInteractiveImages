...
vec3 generateRGB(float x, float y){
    float r = bri(cos(pow(aud(0.029925585,pow((x+0.41333055),var((0.2522934+0.044114113)))),(tan(bri((x+y),(y+y)))+max(min(tan((((0.3246351+x)+(x+x))/bri((y+x),(0.37838602+y)))),tan((0.8993477+y))),tan(((0.23660141+x)+cos(x))))))),(x+x));
    float g = bri(cos(pow(aud(x,pow((x+x),var((y+0.4722916)))),(tan(bri((y+x),(y+y)))+max(min(tan((((y+y)+(0.19337368+x))/bri((y+0.91472054),(0.19956905+x)))),tan((y+0.7671164))),tan(((y+y)+cos(x))))))),(x+x));
    float b = bri(cos(pow(aud(y,pow((x+y),var((0.67841613+x)))),(tan(bri((x+0.7654905),(x+y)))+max(min(tan((((0.8967957+x)+(y+0.27853668))/bri((0.38362777+y),(x+y)))),tan((x+x))),tan(((x+0.995447)+cos(y))))))),(0.7150047+y));
    return vec3(r,g,b);
}
