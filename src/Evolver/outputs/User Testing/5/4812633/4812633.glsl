...
vec3 generateRGB(float x, float y){
    float r = min(tan(pow(aud((x+0.11820406),0.30113965),(cos(min(((y+(x+0.4277063))*(((y+x)+(y+x))+((y+0.108587265)-y))),(x+(x+0.5046807))))-pow(min(tan((x*bri((0.0+x),(y+x)))),tan((y+(0.77094144+0.5003693)))),sin(y))))),(y+y));
    float g = min(tan(pow(aud((x+y),0.9290353),(cos(min(((0.37637776+(y+0.03798741))*(((0.19189203+y)+(x+x))+((y+y)-y))),(y+(0.06529105+x))))-pow(min(tan((y*bri((0.0+0.667631),(y+0.30332816)))),tan((y+(x+y)))),sin(y))))),(0.8347664+y));
    float b = min(tan(pow(aud((x+0.9549669),x),(cos(min(((y+(y+y))*(((0.5984566+x)+(x+y))+((0.22281808+x)-y))),(y+(y+x))))-pow(min(tan((0.8729893*bri((0.0+0.73308384),(x+0.33951297)))),tan((x+(y+0.9015484)))),sin(0.44737905))))),(0.87878036+0.063249886));
    return vec3(r,g,b);
}
