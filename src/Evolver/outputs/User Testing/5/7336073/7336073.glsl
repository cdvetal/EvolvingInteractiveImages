...
vec3 generateRGB(float x, float y){
    float r = (((tan((0.87391984+x))/pow(0.7308161,var(((0.82194275+0.9760212)/y))))/(cos((0.18020833+(y+y)))-cos(aud(aud(pow(y,y),pow((min(sin(0.6879457),min(0.24976976,0.46243447))+pow(max(x,0.67039776),(y+x))),((min(0.05360216,0.0)/x)+x))),aud(bri(tan(sin(sin(y))),(x+y)),(((y+x)+0.7795903)*(x+x)))))))+x);
    float g = (((tan((y+y))/pow(x,var(((y+x)/0.98168564))))/(cos((x+(x+y)))-cos(aud(aud(pow(y,x),pow((min(sin(0.102665864),min(0.9135341,y))+pow(max(x,y),(x+0.40956956))),((min(0.8975394,0.0)/y)+x))),aud(bri(tan(sin(sin(0.9493702))),(y+0.042038977)),(((0.11633724+y)+0.3496794)*(y+0.8410256)))))))+0.79246795);
    float b = (((tan((y+y))/pow(0.8967238,var(((y+y)/0.34080613))))/(cos((x+(y+0.82775277)))-cos(aud(aud(pow(0.7436237,y),pow((min(sin(y),min(y,0.0))+pow(max(x,x),(x+x))),((min(x,0.0)/x)+x))),aud(bri(tan(sin(sin(y))),(y+x)),(((0.3859082+0.30979854)+y)*(y+0.9042036)))))))+0.06935978);
    return vec3(r,g,b);
}
