...
vec3 generateRGB(float x, float y){
    float r = aud(mod(((0.86607367+y)+(y+0.06729752)),pow(noi(max(sin(cos(noi(aud((x+y),(0.5728948+x)),(x+(x+0.8401226))))),mod(noi((x+0.67115057),max(pow((x+0.85354954),(0.03977698+y)),x)),(y+x))),(y+y)),(x+(x+x)))),x);
    float g = aud(mod(((y+0.35097116)+(0.5475143+y)),pow(noi(max(sin(cos(noi(aud((0.6151235+x),(0.0561381+x)),(0.8029316+(0.65152985+y))))),mod(noi((0.80110556+x),max(pow((0.9253875+0.0),(y+0.7622663)),y)),(y+x))),(x+0.7359284)),(0.16089553+(0.63524115+0.5407108)))),y);
    float b = aud(mod(((x+y)+(x+x)),pow(noi(max(sin(cos(noi(aud((0.5382421+x),(x+x)),(y+(y+0.038047493))))),mod(noi((x+x),max(pow((y+y),(x+0.05108303)),x)),(x+y))),(y+y)),(0.94047743+(y+0.23874092)))),x);
    return vec3(r,g,b);
}
