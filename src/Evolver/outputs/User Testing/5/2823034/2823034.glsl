...
vec3 generateRGB(float x, float y){
    float r = bri(var(pow(aud((x+0.11820406),pow(((x+0.31677622)+x),var(x))),(cos(bri((0.70685756+(0.15241295+y)),x))-min(min(tan((x*bri((x+x),(y+x)))),tan((y+x))),cos(y))))),(y+y));
    float g = bri(var(pow(aud((x+y),pow(((x+0.21007311)+y),var(x))),(cos(bri((0.5667159+(x+0.9058256)),x))-min(min(tan((x*bri((x+0.667631),(y+0.30332816)))),tan((y+x))),cos(y))))),(0.8347664+y));
    float b = bri(var(pow(aud((x+0.9549669),pow(((y+0.15854108)+y),var(0.4426741))),(cos(bri((y+(y+x)),x))-min(min(tan((x*bri((0.58911735+0.50184435),(x+0.33951297)))),tan((x+0.83972454))),cos(0.44737905))))),(0.87878036+0.063249886));
    return vec3(r,g,b);
}
