...
vec3 generateRGB(float x, float y){
    float r = bri(tan(pow(aud(0.029925585,pow((x+(0.9555271+x)),var((y+y)))),(tan(max((0.70685756+x),(x+y)))-max(max(tan((x*aud(y,(y+x)))),tan(((0.64313954+0.6660404)+x))),cos(y))))),(y-(0.51413924+y)));
    float g = bri(tan(pow(aud(x,pow((x+(0.40784383+x)),var((0.10157043+0.9602267)))),(tan(max((0.5667159+0.45447832),(y+0.38360953)))-max(max(tan((x*aud(x,(y+0.43965206)))),tan(((x+y)+x))),cos(y))))),(0.8347664-(0.43363184+x)));
    float b = bri(tan(pow(aud(y,pow((y+(0.45312685+y)),var((y+y)))),(tan(max((y+x),(y+y)))-max(max(tan((x*aud(y,(x+0.2603531)))),tan(((x+x)+0.83972454))),cos(0.44737905))))),(0.87878036-(x+0.9409139)));
    return vec3(r,g,b);
}
