...
vec3 generateRGB(float x, float y){
    float r = (((tan(y)*pow(0.7308161,var(sin(x))))/(sin((0.18020833+0.2568807))-cos(aud(aud(pow(y,y),pow((max(sin(0.8288326),min(0.24976976,0.46243447))+pow(max(x,0.67039776),(y+x))),y)),aud(bri(tan(sin((y/0.9477033))),(x+y)),((y+0.7795903)*(x+x)))))))+x);
    float g = (((tan(0.17062193)*pow(x,var(sin(x))))/(sin((x+0.9486122))-cos(aud(aud(pow(y,x),pow((max(sin(0.024555981),min(0.9135341,y))+pow(max(x,y),(x+0.40956956))),y)),aud(bri(tan(sin((0.7826232/x))),(y+0.042038977)),((y+0.3496794)*(y+0.8410256)))))))+0.79246795);
    float b = (((tan(x)*pow(0.8967238,var(sin(x))))/(sin((x+x))-cos(aud(aud(pow(0.7436237,y),pow((max(sin(y),min(y,0.1727981))+pow(max(x,x),(x+x))),y)),aud(bri(tan(sin((y/x))),(y+x)),((x+y)*(y+0.9042036)))))))+0.06935978);
    return vec3(r,g,b);
}
