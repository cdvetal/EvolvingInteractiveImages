...
vec3 generateRGB(float x, float y){
    float r = bri(cos(pow(aud(0.029925585,pow((x+x),var(x))),(tan(max((0.70685756+x),x))-max(min(tan((x*bri(y,(y+x)))),tan((y+x))),cos(y))))),(y+y));
    float g = bri(cos(pow(aud(x,pow((x+y),var(x))),(tan(max((0.5667159+0.45447832),x))-max(min(tan((x*bri(x,(y+0.30332816)))),tan((y+x))),cos(y))))),(0.8347664+y));
    float b = bri(cos(pow(aud(y,pow((y+y),var(0.4426741))),(tan(max((y+x),x))-max(min(tan((x*bri(y,(x+0.2603531)))),tan((x+0.83972454))),cos(0.44737905))))),(0.87878036+0.063249886));
    return vec3(r,g,b);
}
