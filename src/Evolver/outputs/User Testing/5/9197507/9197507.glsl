...
vec3 generateRGB(float x, float y){
    float r = bri(cos(pow(var(0.029925585),(tan(min((0.70685756+x),x))-max(min(tan(((x+y)-bri(y,(y+x)))),bri(x,(0.013297677+y))),cos(y))))),(y+(0.5486548+y)));
    float g = bri(cos(pow(var(x),(tan(min((0.5667159+0.45447832),x))-max(min(tan(((0.85315865+y)-bri(x,(y+0.30332816)))),bri(y,(0.048939764+0.46322984))),cos(y))))),(0.8347664+(0.77825636+0.07595301)));
    float b = bri(cos(pow(var(y),(tan(min((y+x),x))-max(min(tan(((0.7543096+x)-bri(y,(x+0.2603531)))),bri(0.8120885,(y+0.23024726))),cos(0.44737905))))),(0.87878036+(0.76976055+0.3424716)));
    return vec3(r,g,b);
}
