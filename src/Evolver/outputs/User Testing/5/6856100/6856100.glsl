...
vec3 generateRGB(float x, float y){
    float r = (((cos((x+x))-min(((x+0.12438297)+(0.0019260049+x)),var(cos(((y+y)+(0.6123158+y))))))*(tan(((0.1956135+0.3326549)+x))-(min(bri(min((0.8800877+y),y),pow((max(sin(0.8288326),max(0.064328626,0.4059586))+pow(max(x,0.48933995),(0.09497237+y))),(((x+y)+(y+y))+((x+x)+(0.8956847+0.09321481))))),bri(bri(cos(((y*0.74752533)/min(y,y))),((0.81563455+y)+y)),((((x+x)+0.9877746)+(y+y))*0.90426815)))/x)))+(y+x));
    float g = (((cos((x+0.44635803))-min(((0.5599982+y)+(x+0.12807083)),var(cos(((x+x)+(x+0.6620139))))))*(tan(((0.186553+y)+x))-(min(bri(min((y+y),x),pow((max(sin(0.024555981),max(0.961345,y))+pow(max(x,y),(x+0.33155608))),(((y+x)+(x+x))+((0.64816976+x)+(0.6093387+0.06879115))))),bri(bri(cos(((0.69898343*x)/min(y,x))),((y+0.39406407)+y)),((((0.3818645+y)+x)+(x+y))*y)))/y)))+(0.0038897395+0.28996414));
    float b = (((cos((y+x))-min(((x+x)+(0.45574182+x)),var(cos(((x+0.3731178)+(x+y))))))*(tan(((y+x)+0.89760035))-(min(bri(min((y+x),y),pow((max(sin(y),max(y,0.1727981))+pow(max(x,x),(0.7499054+0.16752613))),(((x+x)+(x+y))+((0.86401856+x)+(0.40676326+0.631956))))),bri(bri(cos(((y*x)/min(x,0.24359804))),((0.56251+x)+y)),((((x+0.03120035)+0.6274921)+(y+0.60801387))*y)))/y)))+(x+0.07984543));
    return vec3(r,g,b);
}
