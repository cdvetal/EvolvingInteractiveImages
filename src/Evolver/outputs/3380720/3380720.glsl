...
vec3 generateRGB(float x, float y){
    float r = aud(aud((cos(max(y,y))-((0.42403334/0.53097653)/x)),pow(max(bri(y,0.15028185),y),x)),aud(y,x));
    float g = aud(aud((cos(max(0.6019122,0.41819295))-((x/0.86869115)/0.89020836)),pow(max(bri(x,y),x),x)),aud(x,0.3076288));
    float b = aud(aud((cos(max(x,y))-((y/0.22326672)/y)),pow(max(bri(x,x),x),x)),aud(y,x));
    return vec3(r,g,b);
}
