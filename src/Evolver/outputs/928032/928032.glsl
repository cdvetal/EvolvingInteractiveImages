...
vec3 generateRGB(float x, float y){
    float r = (min(bri(((x-(y+x))+((0.23220247/0.53097653)/x)),pow(aud(bri(y,0.1497643),y),x)),x)/y);
    float g = (min(bri(((y-(0.5601352+x))+((x/0.86869115)/0.89020836)),pow(aud(bri(x,y),x),x)),0.36480492)/x);
    float b = (min(bri(((x-(y+x))+((y/0.22326672)/y)),pow(aud(bri(x,x),0.87466514),x)),0.827727)/0.30642325);
    return vec3(r,g,b);
}
