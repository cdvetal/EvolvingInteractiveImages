...
vec3 generateRGB(float x, float y){
    float r = pow(min(0.7410536,pow(sin(min(min(y,0.23477244),min(0.07414484,min(y,tan(tan(0.5854132)))))),x)),tan(y));
    float g = pow(min(x,pow(sin(min(min(externalVal,externalVal),min(0.2060585,min(x,tan(tan(externalVal)))))),y)),tan(0.019310236));
    float b = pow(min(0.09627485,pow(sin(min(min(externalVal,externalVal),min(y,min(y,tan(tan(y)))))),x)),tan(y));
    return vec3(r,g,b);
}
