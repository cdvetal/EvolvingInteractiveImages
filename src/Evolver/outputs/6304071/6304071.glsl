...
vec3 generateRGB(float x, float y){
    float r = bri(((var(x)+x)*cos(y)),bri(((aud(aud(x,y),var(y))*y)/var(x)),bri(cos(tan(y)),y)));
    float g = bri(((var(0.37912273)+0.15055025)*cos(x)),bri(((aud(aud(0.37912273,0.58147395),var(y))*x)/var(y)),bri(cos(tan(0.6223367)),y)));
    float b = bri(((var(x)+x)*cos(x)),bri(((aud(aud(x,x),var(0.7814684))*0.9784139)/var(x)),bri(cos(tan(x)),x)));
    return vec3(r,g,b);
}
