...
vec3 generateRGB(float x, float y){
    float r = max(sin((sin(0.70760006)*x)),pow(((tan((aul(y,y)+((var((x*y))/x)+(x/(y-y)))))*x)-x),tan(sin((cos(var(var(cos(sin(0.29227588)))))+tan(pow(cos(y),aud((0.07338144-tan(0.082540244)),pow(y,var(pow(x,0.7577566)))))))))));
    float g = max(sin((sin(y)*0.33513993)),pow(((tan((aul(x,0.010176234)+((var((y*y))/0.8859395)+(0.5443487/(x-y)))))*y)-x),tan(sin((cos(var(var(cos(sin(y)))))+tan(pow(cos(y),aud((y-tan(y)),pow(x,var(pow(x,0.64912015)))))))))));
    float b = max(sin((sin(x)*y)),pow(((tan((aul(y,y)+((var((x*0.0))/0.81801957)+(y/(x-x)))))*0.1546013)-y),tan(sin((cos(var(var(cos(sin(x)))))+tan(pow(cos(0.37648907),aud((0.9216292-tan(x)),pow(0.16556221,var(pow(y,x)))))))))));
    return vec3(r,g,b);
}
