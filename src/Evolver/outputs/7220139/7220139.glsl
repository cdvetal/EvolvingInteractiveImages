...
vec3 generateRGB(float x, float y){
    float r = bri(x,bri(sin((aud(aud(x,y),tan(y))-y)),bri(cos(var(y)),y)));
    float g = bri(0.4085111,bri(sin((aud(aud(0.37912273,0.8517875),tan(y))-x)),bri(cos(var(0.6223367)),y)));
    float b = bri(0.87021697,bri(sin((aud(aud(x,x),tan(0.7814684))-0.9784139)),bri(cos(var(x)),x)));
    return vec3(r,g,b);
}
