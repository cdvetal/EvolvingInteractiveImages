...
vec3 generateRGB(float x, float y){
    float r = cos(var(mod(pow(noise(cos(0.2383089),y),0.38355052),0.20838314)));
    float g = cos(var(mod(pow(noise(cos(y),x),0.89957696),y)));
    float b = cos(var(mod(pow(noise(cos(x),y),x),x)));
    return vec3(r,g,b);
}
