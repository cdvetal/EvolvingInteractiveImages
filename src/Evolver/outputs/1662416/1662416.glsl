...
vec3 generateRGB(float x, float y){
    float r = ((tan(y)-bri(var(0.33376247),(0.31660616+y)))/sin((y*y)));
    float g = ((tan(x)-bri(var(y),(0.51226044+y)))/sin((0.0015610456*0.87914014)));
    float b = ((tan(x)-bri(var(0.24742359),(y+0.72672576)))/sin((0.3327309*0.28304726)));
    return vec3(r,g,b);
}
