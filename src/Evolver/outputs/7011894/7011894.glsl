...
vec3 generateRGB(float x, float y){
    float r = (aul(x,auh(0.62499315,auh(((sin(0.9400962)+sin(cos(cos(y))))+bri(tan(x),y)),y)))-(y*0.42247117));
    float g = (aul(x,auh(0.84899426,auh(((sin(x)+sin(cos(cos(y))))+bri(tan(y),0.5022717)),y)))-(0.26469344*x));
    float b = (aul(x,auh(y,auh(((sin(y)+sin(cos(cos(x))))+bri(tan(y),0.27238566)),y)))-(y*0.5430123));
    return vec3(r,g,b);
}
