...
// Generation: 0
// Population Size: 18; Elite Size: 1; Mutation Rate: 0.0; Crossover Rate: 0.0; Tournament Size: 3
############################ */
...
vec3 generateRGB(float x, float y){
    float r = aud(aud(x,add(var(mul(min(mul(max(sub(aud(tan(0.8626685),min(y,x)),cos(0.76693887)),var(div(tan(var(tan(cos(y)))),max(aul(cos(sin(x)),min(sub(0.44589794,y),y)),x)))),div(sin(pow(0.50701207,0.9336437)),x)),max(y,aud(y,0.18377781))),x)),0.9961717)),tan(min(y,tan(0.9343064))));
    float g = aud(aud(y,add(var(mul(min(mul(max(sub(aud(tan(0.6255394),min(0.92801857,x)),cos(y)),var(div(tan(var(tan(cos(y)))),max(aul(cos(sin(y)),min(sub(y,0.71647614),0.13822979)),y)))),div(sin(pow(y,x)),0.42988497)),max(y,aud(y,0.41690898))),y)),x)),tan(min(y,tan(y))));
    float b = aud(aud(x,add(var(mul(min(mul(max(sub(aud(tan(x),min(0.42553675,y)),cos(0.6763462)),var(div(tan(var(tan(cos(0.2599039)))),max(aul(cos(sin(y)),min(sub(y,0.45416933),x)),0.340802)))),div(sin(pow(y,0.20887095)),x)),max(y,aud(x,x))),y)),x)),tan(min(y,tan(x))));
    return vec3(r,g,b);
}
