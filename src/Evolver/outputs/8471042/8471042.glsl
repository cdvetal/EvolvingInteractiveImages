...
vec3 generateRGB(float x, float y){
    float r = (((aud(bri(0.4713167,0.50701153),(x*x))/0.8651097)/y)/x);
    float g = (((aud(bri(0.5949735,y),(0.4843703*0.9420156))/y)/0.54898703)/0.84973097);
    float b = (((aud(bri(0.4222589,y),(0.60415953*0.14940369))/0.89152765)/y)/x);
    return vec3(r,g,b);
}
