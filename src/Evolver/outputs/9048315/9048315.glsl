...
vec3 generateRGB(float x, float y){
    float r = tan((max((sin(x)+(y/(pow(max(min(y,x),x),(y/0.72858614))-aud((aud(x,0.0025638342)-y),y)))),x)*(cos(bri(y,(var(x)-bri(0.672168,y))))+y)));
    float g = tan((max((sin(0.017347276)+(x/(pow(max(min(0.82946455,x),y),(0.15528041/x))-aud((aud(y,x)-y),x)))),x)*(cos(bri(0.3749383,(var(0.263156)-bri(y,0.8698992))))+x)));
    float b = tan((max((sin(0.58616924)+(y/(pow(max(min(y,0.84840757),x),(0.6749561/0.13958341))-aud((aud(x,x)-x),0.43275994)))),0.28159064)*(cos(bri(y,(var(y)-bri(y,y))))+0.4482395)));
    return vec3(r,g,b);
}
