...
vec3 generateRGB(float x, float y){
    float r = min(pow((0.4800657/x),sin(0.34426385)),(aul(0.020499766,0.01467526)+(0.25018734-x)));
    float g = min(pow((y/y),sin(y)),(aul(y,0.18869537)+(x-x)));
    float b = min(pow((y/0.019206226),sin(x)),(aul(0.54803306,x)+(y-0.6738492)));
    return vec3(r,g,b);
}
