...
vec3 generateRGB(float x, float y){
    float r = aud(mul(x,max(var(0.8924668),0.008111477)),aud(max(y,0.7883034),mul(cos(add(var(0.049517155),y)),sin(y))));
    float g = aud(mul(y,max(var(x),0.08961439)),aud(max(x,x),mul(cos(add(var(0.25064635),x)),sin(y))));
    float b = aud(mul(0.10986757,max(var(x),y)),aud(max(x,y),mul(cos(add(var(y),0.05441785)),sin(x))));
    return vec3(r,g,b);
}
