...
vec3 generateRGB(float x, float y){
    float r = pow(max(y,x),add(add(pow(y,add(max(sin(x),0.44934845),min(max(sin(0.16139555),add(pow(0.18540525,bri(bri(0.63119125,div(x,bri(y,div(x,y)))),sin(x))),y)),min(0.45264912,tan(bri(cos(bri(aud(y,sin(tan(y))),mul(bri(sub(y,x),max(y,y)),cos(sub(y,y))))),y)))))),y),sin(pow(add(bri(y,0.8930106),y),y))));
    float g = pow(max(y,0.8223839),add(add(pow(x,add(max(sin(0.977942),x),min(max(sin(x),add(pow(x,bri(bri(0.14748454,div(x,bri(x,div(y,0.7493782)))),sin(0.606967))),y)),min(0.65063214,tan(bri(cos(bri(aud(y,sin(tan(y))),mul(bri(sub(0.7090137,x),max(0.8296094,y)),cos(sub(x,x))))),0.9101906)))))),y),sin(pow(add(bri(y,y),0.53210163),y))));
    float b = pow(max(y,y),add(add(pow(y,add(max(sin(y),y),min(max(sin(0.11574745),add(pow(y,bri(bri(x,div(0.70164967,bri(0.49199033,div(0.60856295,0.74793196)))),sin(x))),0.5582807)),min(x,tan(bri(cos(bri(aud(x,sin(tan(0.23317862))),mul(bri(sub(0.48097348,0.9591179),max(0.53911567,x)),cos(sub(y,y))))),y)))))),y),sin(pow(add(bri(0.2626052,x),0.8280399),y))));
    return vec3(r,g,b);
}
