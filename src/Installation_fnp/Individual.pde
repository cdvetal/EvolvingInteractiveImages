class Individual {
  ...
  void doShader(int _index) {
    ...
    String fragShaderPath = sketchPath("shaders\\individuals\\shader" + _index + ".glsl");

    saveStrings(fragShaderPath, shaderLines);

    shader = loadShader(fragShaderPath, "vertShaderTemplate.glsl");
  }
