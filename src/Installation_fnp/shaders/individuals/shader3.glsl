...
vec3 generateRGB(float x, float y){
    float r = mod((tan((((0.88388604/tan(x))-y)/0.71750665))*(min(mod((max(0.5960337,y)-sin(y)),pow(bri(x,x),pow(x,y))),(max(0.12462008,max(y,x))*x))-min(((pow(x,0.9093976)+(x*y))*((0.48162425-0.16381842)+(x-0.39826655))),(min((y-y),max(0.27652037,y))-0.79607767)))),cos(cos(((mod(0.17745298,bri(y,0.8373059))*max(0.09261793,tan(y)))-x))));
    float g = mod((tan((((0.19889367/tan(0.39279664))-x)/0.58098865))*(min(mod((max(0.071513236,x)-sin(y)),pow(bri(y,0.40772527),pow(0.49897474,y))),(max(y,max(x,x))*0.24635035))-min(((pow(0.07919258,0.066776276)+(y*0.04717809))*((y-0.49475187)+(x-y))),(min((y-x),max(x,0.5815199))-x)))),cos(cos(((mod(0.34895843,bri(y,y))*max(y,tan(0.13143897)))-0.2626977))));
    float b = mod((tan((((x/tan(x))-y)/y))*(min(mod((max(0.8829215,x)-sin(y)),pow(bri(0.571789,0.8515241),pow(y,x))),(max(y,max(0.7318967,x))*x))-min(((pow(x,x)+(x*y))*((y-0.005837202)+(x-y))),(min((x-0.6295672),max(0.029824555,x))-y)))),cos(cos(((mod(y,bri(x,0.15000737))*max(y,tan(y)))-0.015150726))));
    return vec3(r,g,b);
}
