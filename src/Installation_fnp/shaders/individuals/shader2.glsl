...
vec3 generateRGB(float x, float y){
    float r = sin((min(bri(pow((max(x,x)+(0.8611418/y)),x),max(tan(y),(sin(0.993237)*(x/y)))),y)/(y-(tan(max((y*x),max(y,y)))-cos(cos(sin(y)))))));
    float g = sin((min(bri(pow((max(0.14291292,0.4783321)+(0.81263727/0.32674742)),x),max(tan(y),(sin(0.7469521)*(y/y)))),y)/(0.46532518-(tan(max((y*0.098012924),max(0.13609296,0.9961733)))-cos(cos(sin(0.90112674)))))));
    float b = sin((min(bri(pow((max(x,x)+(x/0.9012131)),0.40559953),max(tan(0.68110085),(sin(0.06107515)*(y/x)))),x)/(x-(tan(max((x*y),max(y,x)))-cos(cos(sin(0.60101795)))))));
    return vec3(r,g,b);
}
