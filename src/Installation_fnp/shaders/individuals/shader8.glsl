...
vec3 generateRGB(float x, float y){
    float r = (pow(y,tan(((x*(sin(x)/max(y,x)))/(cos((y+0.23944777))-y))))/(y-bri(((x+pow(x,max(x,y)))+min((x/(y*0.82321125)),((0.36310512/y)-cos(0.879592)))),(bri(0.8430337,cos(max(0.94132376,x)))/0.10236418))));
    float g = (pow(y,tan(((x*(sin(x)/max(0.492678,y)))/(cos((0.2508602+x))-x))))/(0.011419058-bri(((0.8510474+pow(y,max(y,y)))+min((y/(0.9688137*y)),((0.37104446/0.70313305)-cos(0.93612635)))),(bri(y,cos(max(0.9696273,x)))/0.12209147))));
    float b = (pow(x,tan(((0.36747175*(sin(0.59840995)/max(y,x)))/(cos((y+y))-0.7902873))))/(y-bri(((x+pow(0.7351815,max(y,x)))+min((y/(0.23952842*y)),((0.5084347/y)-cos(0.9493738)))),(bri(y,cos(max(x,x)))/x))));
    return vec3(r,g,b);
}
