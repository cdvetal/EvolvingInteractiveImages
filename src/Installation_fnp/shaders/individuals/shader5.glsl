...
vec3 generateRGB(float x, float y){
    float r = mod(sin(min((((cos(x)+pow(0.54763645,y))-bri(bri(y,0.089423954),0.7801248))+(mod(max(x,0.281326),mod(0.3358689,y))/bri((y/x),tan(0.58765054)))),min(tan(sin(0.09995717)),y))),y);
    float g = mod(sin(min((((cos(x)+pow(x,y))-bri(bri(y,x),0.92649597))+(mod(max(y,x),mod(x,0.97040695))/bri((y/x),tan(0.6570162)))),min(tan(sin(0.33932197)),0.95510083))),y);
    float b = mod(sin(min((((cos(y)+pow(0.4822551,x))-bri(bri(x,y),x))+(mod(max(y,x),mod(x,x))/bri((0.17165011/y),tan(x)))),min(tan(sin(x)),x))),y);
    return vec3(r,g,b);
}
