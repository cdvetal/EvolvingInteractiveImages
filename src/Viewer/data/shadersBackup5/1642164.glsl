...
vec3 generateRGB(float x, float y){
    float r = (aul((0.28046036/0.31274235),(sin(min(auh(tan(sin(tan(0.6716865))),x),cos(y)))*aud((aul(x,x)+(min((pow(y,y)+x),max(max(y,0.8450033),y))*y)),((0.97297776-tan(x))+y))))/0.22956137);
    float g = (aul((y/x),(sin(min(auh(tan(sin(tan(0.057425916))),x),cos(x)))*aud((aul(y,0.13798559)+(min((pow(y,0.73775995)+x),max(max(x,y),x))*0.13591133)),((0.33604333-tan(0.9544607))+0.62548304))))/0.8588521);
    float b = (aul((x/y),(sin(min(auh(tan(sin(tan(0.88187546))),x),cos(0.51935285)))*aud((aul(y,x)+(min((pow(x,x)+x),max(max(y,0.6457839),0.31286696))*x)),((y-tan(x))+x))))/0.88818777);
    return vec3(r,g,b);
}
