...
vec3 generateRGB(float x, float y){
    float r = noise(min(cos(x),0.55293083),(((tan(max((sin(noise(y,x))+x),y))+0.8906864)*0.0)-(y*(0.24236465/0.543221))));
    float g = noise(min(cos(x),externalVal),(((tan(max((sin(noise(0.55953884,x))+externalVal),x))+externalVal)*externalVal)-(0.030382633*(x/externalVal))));
    float b = noise(min(cos(externalVal),y),(((tan(max((sin(noise(y,y))+x),x))+x)*externalVal)-(0.9094732*(y/0.85495985))));
    return vec3(r,g,b);
}
