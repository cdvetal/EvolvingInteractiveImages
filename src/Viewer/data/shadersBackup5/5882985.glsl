...
vec3 generateRGB(float x, float y){
    float r = (min(bri(min(x,0.6269254),pow(bri(min(0.24815422,(tan(pow(0.42485243,y))-bri(x,(y/x)))),x),(sin(0.16072619)-(cos(0.43706846)/pow(x,cos(auh(x,x))))))),(0.3674655+sin(min(y,0.29960686))))-pow((tan(pow(tan(aud(0.40609288,(y*bri(y,y)))),aul(cos(sin(tan(x))),0.116936624)))-y),y));
    float g = (min(bri(min(y,x),pow(bri(min(x,(tan(pow(0.0874781,x))-bri(y,(0.8065324/x)))),x),(sin(0.42744595)-(cos(y)/pow(x,cos(auh(y,x))))))),(x+sin(min(0.6263278,0.8528618))))-pow((tan(pow(tan(aud(0.9697997,(0.9105565*bri(x,x)))),aul(cos(sin(tan(y))),0.20145947)))-y),0.26037133));
    float b = (min(bri(min(y,0.66924155),pow(bri(min(0.63876003,(tan(pow(0.047738135,x))-bri(x,(y/x)))),y),(sin(y)-(cos(0.22702307)/pow(x,cos(auh(y,0.5260205))))))),(x+sin(min(0.9775915,y))))-pow((tan(pow(tan(aud(x,(y*bri(x,y)))),aul(cos(sin(tan(0.11669433))),0.09766513)))-y),x));
    return vec3(r,g,b);
}
