...
vec3 generateRGB(float x, float y){
    float r = (aud(aud(x,x),((auh(max(tan((sin(0.863934)-y)),x),tan(y))*0.5196142)/aud((aud(x,x)+(min((pow(y,y)-x),pow(max(x,x),y))-x)),((x+sin(aud(sin(x),pow(x,0.9921947))))-y))))*0.13033104);
    float g = (aud(aud(0.9792596,x),((auh(max(tan((sin(0.057425916)-y)),x),tan(x))*y)/aud((aud(y,0.3572508)+(min((pow(y,0.50442195)-x),pow(max(y,y),x))-0.16427708)),((0.31440216+sin(aud(sin(x),pow(0.49318966,y))))-0.40993756))))*0.48410475);
    float b = (aud(aud(y,y),((auh(max(tan((sin(0.88187546)-0.542225)),x),tan(0.22136392))*0.6209169)/aud((aud(y,y)+(min((pow(x,x)-x),pow(max(0.6846655,0.8306905),0.28188056))-x)),((y+sin(aud(sin(y),pow(x,y))))-x))))*0.96410716);
    return vec3(r,g,b);
}
