...
vec3 generateRGB(float x, float y){
    float r = ((mod(x,((aul(aul((cos(x)*(0.40457815-x)),x),bri(((y/x)/x),y))-0.014789298)*0.8108724))/x)/mod(aul(aul(0.36448017,aul(tan((tan((0.53063405/y))*(x/0.96180815))),x)),x),(y/tan(0.8886788))));
    float g = ((mod(0.52434313,((aul(aul((cos(x)*(x-x)),x),bri(((x/0.78692436)/y),y))-y)*x))/y)/mod(aul(aul(x,aul(tan((tan((x/0.039612114))*(x/0.20549476))),0.88602126)),y),(y/tan(y))));
    float b = ((mod(0.0,((aul(aul((cos(0.29372287)*(0.269539-x)),y),bri(((0.5461768/0.9184964)/y),0.15274447))-y)*0.2421995))/0.0)/mod(aul(aul(0.42351,aul(tan((tan((0.8397025/x))*(0.4140518/x))),y)),y),(x/tan(0.6596991))));
    return vec3(r,g,b);
}
