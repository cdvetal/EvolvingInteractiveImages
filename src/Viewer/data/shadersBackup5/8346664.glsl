...
vec3 generateRGB(float x, float y){
    float r = (((sin(x)*auh(x,y))/aud(bri(y,y),sin(aul((cos((sin((x/0.32275218))/auh(aud(y,x),x)))*(aud(sin(aud(x,0.5946556)),(sin(x)-sin(y)))-y)),(0.015572369/x)))))/0.72778857);
    float g = (((sin(x)*auh(x,y))/aud(bri(x,y),sin(aul((cos((sin((y/x))/auh(aud(y,y),0.597118)))*(aud(sin(aud(x,0.4380818)),(sin(x)-sin(x)))-x)),(0.77857554/0.04297346)))))/0.35044342);
    float b = (((sin(x)*auh(x,y))/aud(bri(x,y),sin(aul((cos((sin((0.40111613/y))/auh(aud(0.8257116,y),x)))*(aud(sin(aud(x,0.30265206)),(sin(x)-sin(x)))-y)),(0.53671074/x)))))/0.931276);
    return vec3(r,g,b);
}
