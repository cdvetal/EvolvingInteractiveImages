...
vec3 generateRGB(float x, float y){
    float r = bri(y,y);
    float g = bri(bri(audio(audio(y,externalVal),audio(y,bri(externalVal,audio(audio(bri(y,bri(bri(x,externalVal),bri(y,bri(externalVal,y)))),x),x)))),bri(x,y)),bri(audio(y,audio(externalVal,audio(bri(bri(audio(externalVal,bri(audio(bri(bri(y,y),audio(externalVal,audio(x,bri(y,bri(x,x))))),audio(externalVal,x)),bri(bri(y,externalVal),x))),bri(y,externalVal)),x),externalVal))),audio(audio(y,x),externalVal)));
    float b = bri(bri(bri(externalVal,x),x),x);
    return vec3(r,g,b);
}
