...
vec3 generateRGB(float x, float y) {
    float r = aul(aud(aud(0.6155362,y),var(aul(sub(aul(x,aul(add(aud(0.49610734,0.8237319),add(x,y)),0.028317213)),sub(auh(aul(x,0.3302281),sub(x,x)),var(var(add(x,x))))),sub(x,y)))),aud(auh(y,y),0.6310508));
    float g = aul(aud(aud(x,0.32774997),var(aul(sub(aul(0.56892014,aul(add(aud(x,y),add(0.7916286,y)),x)),sub(auh(aul(y,0.5096767),sub(y,x)),var(var(add(0.40035915,0.0645051))))),sub(x,x)))),aud(auh(0.5373373,0.5591216),x));
    float b = aul(aud(aud(x,0.45811534),var(aul(sub(aul(y,aul(add(aud(x,0.42636442),add(0.8413904,0.1839993)),0.18904638)),sub(auh(aul(0.5249872,y),sub(0.7312894,x)),var(var(add(y,x))))),sub(x,0.10885644)))),aud(auh(y,0.6465697),y));
    return vec3(r, g, b);
}
