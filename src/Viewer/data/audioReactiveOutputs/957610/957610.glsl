...
vec3 generateRGB(float x, float y) {
    float r = sub(cos(aud(x,x)),sin(aud(aud(0.6183405,mul(cos(mul(add(x,aud(sin(x),0.04122019)),x)),div(sub(0.040394783,tan(sub(add(0.4984808,x),0.34531307))),aud(x,y)))),aud(0.26774287,mul(x,aud(aud(tan(aud(0.52214146,0.3103733)),mul(0.9423311,cos(x))),sin(0.33897424)))))));
    float g = sub(cos(aud(0.3633697,0.8563745)),sin(aud(aud(x,mul(cos(mul(add(x,aud(sin(x),0.82736397)),y)),div(sub(x,tan(sub(add(y,x),x))),aud(0.30387902,y)))),aud(y,mul(x,aud(aud(tan(aud(x,x)),mul(0.056239605,cos(x))),sin(x)))))));
    float b = sub(cos(aud(y,y)),sin(aud(aud(0.6330824,mul(cos(mul(add(x,aud(sin(x),x)),0.1306448)),div(sub(0.3934412,tan(sub(add(x,x),x))),aud(y,y)))),aud(x,mul(x,aud(aud(tan(aud(0.35830307,x)),mul(x,cos(0.39917588))),sin(y)))))));
    return vec3(r, g, b);
}
