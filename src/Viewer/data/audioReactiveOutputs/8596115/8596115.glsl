...
vec3 generateRGB(float x, float y) {
    float r = add(tan(sub(div(pow(add(y,sin(cos(y))),tan(y)),var(aud(cos(y),min(x,var(max(x,y)))))),0.5738716)),cos(aud(div(cos(y),aud(x,x)),0.5585079)));
    float g = add(tan(sub(div(pow(add(x,sin(cos(y))),tan(0.42284107)),var(aud(cos(0.11987877),min(0.55967903,var(max(x,x)))))),0.075570345)),cos(aud(div(cos(x),aud(x,0.6770928)),0.19137096)));
    float b = add(tan(sub(div(pow(add(y,sin(cos(y))),tan(x)),var(aud(cos(x),min(0.23898554,var(max(x,0.09903002)))))),0.2943673)),cos(aud(div(cos(x),aud(y,y)),0.21464705)));
    return vec3(r, g, b);
}
