...
vec3 generateRGB(float x, float y) {
    float r = div(bri(sin(0.24372864),div(sub(x,sub(div(x,x),x)),mul(var(mul(y,var(cos(aud(y,0.34698772))))),min(mul(pow(sub(pow(y,y),add(y,0.0925343)),y),cos(add(tan(y),bri(x,y)))),x)))),0.12850308);
    float g = div(bri(sin(y),div(sub(0.6341529,sub(div(y,y),y)),mul(var(mul(y,var(cos(aud(0.2576053,0.024235249))))),min(mul(pow(sub(pow(0.7610185,0.4759388),add(x,x)),0.9179492),cos(add(tan(x),bri(x,0.062007904)))),0.85335207)))),y);
    float b = div(bri(sin(x),div(sub(y,sub(div(y,x),x)),mul(var(mul(0.15452147,var(cos(aud(y,0.918576))))),min(mul(pow(sub(pow(y,y),add(x,x)),0.59471154),cos(add(tan(y),bri(0.9481468,x)))),x)))),x);
    return vec3(r, g, b);
}
