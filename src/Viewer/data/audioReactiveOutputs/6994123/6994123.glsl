...
vec3 generateRGB(float x, float y) {
    float r = var(bri(y,var(aud(bri(var(aud(y,var(cos(y)))),aud(x,bri(var(cos(0.95217705)),bri(var(y),sin(x))))),bri(aud(bri(bri(0.30479288,bri(x,y)),y),sin(bri(aud(y,y),y))),x)))));
    float g = var(bri(x,var(aud(bri(var(aud(x,var(cos(0.58449435)))),aud(x,bri(var(cos(x)),bri(var(x),sin(y))))),bri(aud(bri(bri(x,bri(x,0.02881527)),0.76374197),sin(bri(aud(x,y),x))),x)))));
    float b = var(bri(0.07334113,var(aud(bri(var(aud(0.3474741,var(cos(y)))),aud(0.66758156,bri(var(cos(0.033846855)),bri(var(y),sin(0.69936323))))),bri(aud(bri(bri(0.43166304,bri(0.7078941,x)),y),sin(bri(aud(0.26361227,x),y))),0.28799415)))));
    return vec3(r, g, b);
}
