...
vec3 generateRGB(float x, float y) {
    float r = tan(mul(bri(bri(var(y),x),var(mul(min(y,add(bri(x,var(0.46617603)),y)),min(0.5607908,var(sub(y,bri(mul(x,x),var(x)))))))),div(add(x,sub(cos(sub(0.43337798,sub(add(y,x),div(x,x)))),0.16777992)),x)));
    float g = tan(mul(bri(bri(var(0.16309476),y),var(mul(min(y,add(bri(y,var(y)),x)),min(0.3761134,var(sub(y,bri(mul(x,x),var(0.26630735)))))))),div(add(x,sub(cos(sub(0.32744145,sub(add(x,y),div(y,x)))),0.46816063)),y)));
    float b = tan(mul(bri(bri(var(0.9936459),y),var(mul(min(0.5685413,add(bri(0.6970277,var(y)),0.16212678)),min(y,var(sub(x,bri(mul(x,x),var(y)))))))),div(add(x,sub(cos(sub(y,sub(add(x,0.72224355),div(x,y)))),y)),y)));
    return vec3(r, g, b);
}
