...
vec3 generateRGB(float x, float y) {
    float r = aul(aud(var(0.6155362),sub(aul(sub(aul(x,aul(add(aud(0.7914896,0.8237319),add(x,y)),var(auh(y,y)))),sub(0.5743122,aud(var(add(x,x)),auh(auh(x,0.3552966),sub(0.2943504,x))))),var(x)),0.5672536)),aud(auh(y,y),0.6310508));
    float g = aul(aud(var(x),sub(aul(sub(aul(0.62232375,aul(add(aud(x,y),add(0.7916286,y)),var(auh(x,y)))),sub(y,aud(var(add(0.40035915,0.075244665)),auh(auh(0.09330559,0.4529686),sub(0.021193743,x))))),var(x)),0.24297571)),aud(auh(0.5373373,0.6912446),x));
    float b = aul(aud(var(x),sub(aul(sub(aul(y,aul(add(aud(x,0.14417887),add(0.84382915,0.1839993)),var(auh(0.19928312,0.70959353)))),sub(y,aud(var(add(y,x)),auh(auh(0.5249872,y),sub(0.03386879,x))))),var(x)),0.53269243)),aud(auh(y,0.93599415),y));
    return vec3(r, g, b);
}
