...
vec3 generateRGB(float x, float y) {
    float r = tan(sub(y,add(sub(sub(min(cos(tan(max(x,y))),max(aud(y,max(0.70532537,add(0.22712016,x))),aud(add(y,0.23981285),sub(0.53706837,y)))),0.1913929),tan(cos(sub(sub(0.29389763,y),min(0.398129,max(add(x,x),x)))))),0.1870532)));
    float g = tan(sub(y,add(sub(sub(min(cos(tan(max(0.22096682,x))),max(aud(0.5567889,max(0.6912446,add(0.029813528,x))),aud(add(x,x),sub(y,x)))),x),tan(cos(sub(sub(x,0.3294859),min(x,max(add(0.5547037,x),x)))))),x)));
    float b = tan(sub(0.40791154,add(sub(sub(min(cos(tan(max(x,x))),max(aud(x,max(y,add(x,x))),aud(add(1.0,x),sub(y,0.55902815)))),y),tan(cos(sub(sub(x,0.22502732),min(0.5286944,max(add(1.0,x),0.28577805)))))),x)));
    return vec3(r, g, b);
}
