...
vec3 generateRGB(float x, float y){
    float r = (x-sin(sin((((y+x)+(externalVal-bri(externalVal,audio(externalVal,x))))/x))));
    float g = ((y-((x+(bri((y/externalVal),x)-(cos(((y/cos(((y+externalVal)+sin(((sin(bri((externalVal+x),y))*(sin(y)-(externalVal*audio(bri(audio((x*y),audio(((cos(x)+audio(y,cos(audio(sin((y+externalVal)),externalVal))))-externalVal),sin(y))),(y-sin((y+x)))),externalVal))))+(bri(y,(externalVal-sin(externalVal)))*(externalVal-externalVal)))))))*externalVal))-(audio(x,cos(y))*x))))-y))/externalVal);
    float b = (externalVal*audio(externalVal,x));
    return vec3(r,g,b);
}
