...
vec3 generateRGB(float x, float y){
    float r = (min(y,pow(cos(tan(((max(max(y,tan(cos(x))),y)-(y-y))/y))),0.8402251))-x);
    float g = (min(y,pow(cos(tan(((max(max(y,tan(cos(x))),0.15568806)-(x-x))/0.546624))),y))-y);
    float b = (min(x,pow(cos(tan(((max(max(y,tan(cos(y))),x)-(y-x))/x))),x))-0.4896695);
    return vec3(r,g,b);
}
