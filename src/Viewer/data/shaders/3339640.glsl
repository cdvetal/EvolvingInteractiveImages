...
vec3 generateRGB(float x, float y){
    float r = aul(pow(aul(min(((cos(x)+x)*cos(aul(y,0.92752486))),sin(tan(0.44522846))),x),cos(cos(tan((y-sin(aud(auh(0.1139583,x),0.7782526))))))),min(min(0.33259356,x),0.57512015));
    float g = aul(pow(aul(min(((cos(x)+y)*cos(aul(y,x))),sin(tan(y))),x),cos(cos(tan((0.79443634-sin(aud(auh(y,x),x))))))),min(min(x,x),y));
    float b = aul(pow(aul(min(((cos(0.3533013)+0.28349644)*cos(aul(y,y))),sin(tan(y))),x),cos(cos(tan((y-sin(aud(auh(y,x),x))))))),min(min(x,y),0.38947713));
    return vec3(r,g,b);
}
