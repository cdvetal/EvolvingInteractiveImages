...
vec3 generateRGB(float x, float y) {
    float r = bri(aud(pow(tan(sin(bri(y,bri(aud(x,0.99322677),mul(var(0.6931782),y))))),y),x),pow(sub(tan(div(bri(y,bri(aud(y,x),add(cos(0.7197101),y))),x)),sin(sin(cos(0.041810036)))),tan(aud(var(aud(y,y)),y))));
    float g = bri(aud(pow(tan(sin(bri(y,bri(aud(0.29667616,x),mul(var(x),0.7627778))))),0.34163523),0.34503913),pow(sub(tan(div(bri(y,bri(aud(y,0.7287705),add(cos(x),0.7627778))),x)),sin(sin(cos(x)))),tan(aud(var(aud(0.009414673,0.07297516)),x))));
    float b = bri(aud(pow(tan(sin(bri(x,bri(aud(y,0.79606843),mul(var(x),x))))),y),0.840456),pow(sub(tan(div(bri(x,bri(aud(x,x),add(cos(x),y))),x)),sin(sin(cos(y)))),tan(aud(var(aud(x,y)),0.77053785))));
    return vec3(r, g, b);
}
