...
vec3 generateRGB(float x, float y) {
    float r = add(cos(div(aud(0.47942877,div(aud(cos(sin(add(y,sin(tan(0.763669))))),aud(x,x)),0.36560035)),mul(0.65889835,tan(sin(aud(0.7665024,mul(x,aud(aud(mul(sin(y),tan(x)),cos(sub(x,y))),0.6776743)))))))),0.47969937);
    float g = add(cos(div(aud(x,div(aud(cos(sin(add(y,sin(tan(0.83746386))))),aud(0.4890659,x)),x)),mul(y,tan(sin(aud(y,mul(y,aud(aud(mul(sin(0.05020809),tan(x)),cos(sub(x,x))),y)))))))),0.4133067);
    float b = add(cos(div(aud(x,div(aud(cos(sin(add(x,sin(tan(y))))),aud(x,y)),x)),mul(x,tan(sin(aud(x,mul(x,aud(aud(mul(sin(x),tan(x)),cos(sub(x,x))),y)))))))),x);
    return vec3(r, g, b);
}
