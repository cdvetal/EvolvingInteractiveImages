...
vec3 generateRGB(float x, float y){
    float r = tan((((bri(y,mod(sin(mod(sin(0.6331347),x)),cos(tan(y))))+(cos(cos(((x-y)/aul(y,0.8459503))))+x))*((aul(tan(sin(0.7957692)),bri(x,x))/x)+x))+aul(sin(x),(0.91358453*y))));
    float g = tan((((bri(y,mod(sin(mod(sin(0.15696126),x)),cos(tan(y))))+(cos(cos(((0.44112504-x)/aul(0.89572656,x))))+x))*((aul(tan(sin(y)),bri(x,y))/0.86321515)+x))+aul(sin(y),(y*y))));
    float b = tan((((bri(0.6073306,mod(sin(mod(sin(x),0.9696579)),cos(tan(x))))+(cos(cos(((0.9428757-x)/aul(y,0.5615439))))+x))*((aul(tan(sin(x)),bri(y,0.34029114))/0.57377476)+0.4577694))+aul(sin(x),(y*y))));
    return vec3(r,g,b);
}
