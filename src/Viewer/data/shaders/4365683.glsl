...
vec3 generateRGB(float x, float y){
    float r = (((0.35891908*0.21583486)+((y/y)/cos((max(tan(tan(min(tan(((((0.3072322/0.06796664)+tan(y))/x)/(0.2135675+0.48625857))),(y-min(var(max(cos(y),min(y,0.8129897))),0.703905))))),0.15265363)-x))))/x);
    float g = (((x*y)+((x/x)/cos((max(tan(tan(min(tan(((((y/0.11618203)+tan(0.5835171))/y)/(0.89223236+y))),(0.56065285-min(var(max(cos(y),min(y,0.4865343))),x))))),y)-0.8117788))))/0.12653965);
    float b = (((y*y)+((x/y)/cos((max(tan(tan(min(tan(((((0.62779534/x)+tan(y))/x)/(y+x))),(0.23295432-min(var(max(cos(y),min(y,0.22253984))),0.24908566))))),y)-0.37265968))))/x);
    return vec3(r,g,b);
}
