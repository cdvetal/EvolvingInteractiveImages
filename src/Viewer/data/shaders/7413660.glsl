...
vec3 generateRGB(float x, float y){
    float r = (y+((max(x,x)+(max(((min(var(0.36493653),y)+x)/x),y)*aud(y,((min(y,y)/y)*aul(0.0016611814,(x*aud(y,y)))))))+x));
    float g = (y+((max(y,0.20741326)+(max(((min(var(y),x)+y)/y),y)*aud(y,((min(y,y)/y)*aul(y,(0.864462*aud(y,0.45627254)))))))+x));
    float b = (y+((max(0.7361106,y)+(max(((min(var(y),y)+y)/0.65467536),x)*aud(x,((min(0.76845574,y)/y)*aul(y,(x*aud(0.42535597,x)))))))+x));
    return vec3(r,g,b);
}
