...
vec3 generateRGB(float x, float y){
    float r = pow(sin(auh(y,max(tan(y),y))),(tan(pow(var(sin(cos(pow(cos(y),var(x))))),max(aud(tan(aud((y/x),var(x))),aud(pow(aul(tan(y),0.0),aul(x,y)),0.24186534)),0.5056334)))/y));
    float g = pow(sin(auh(0.4453724,max(tan(y),0.82504016))),(tan(pow(var(sin(cos(pow(cos(y),var(0.03406942))))),max(aud(tan(aud((x/x),var(y))),aud(pow(aul(tan(0.30384713),0.26484278),aul(y,x)),0.57899785)),0.35932243)))/x));
    float b = pow(sin(auh(y,max(tan(x),y))),(tan(pow(var(sin(cos(pow(cos(0.90006113),var(x))))),max(aud(tan(aud((y/x),var(y))),aud(pow(aul(tan(y),x),aul(0.02197364,0.93154883)),x)),x)))/0.9401661));
    return vec3(r,g,b);
}
