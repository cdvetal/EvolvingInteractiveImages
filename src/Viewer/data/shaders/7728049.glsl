...
vec3 generateRGB(float x, float y){
    float r = pow((aul(y,min(var(y),y))-tan(aud((aud(y,y)-((cos(pow((var((x*0.8732323))-pow(y,sin(0.8000123))),x))/x)+(0.81878364/(y-pow(x,0.6169249))))),aud(x,auh(x,tan((aul(y,x)/(x-x)))))))),sin(tan(pow(aul(sin(cos(min(cos(y),var(x)))),0.2261585),max(var(tan(aul((y/x),aud(x,x)))),0.5056334)))));
    float g = pow((aul(0.4453724,min(var(y),0.82504016))-tan(aud((aud(x,0.15667963)-((cos(pow((var((x*0.39966756))-pow(y,sin(0.03213626))),y))/x)+(0.61420524/(x-pow(x,0.9931668))))),aud(0.41417813,auh(y,tan((aul(y,y)/(0.7560534-0.0)))))))),sin(tan(pow(aul(sin(cos(min(cos(y),var(0.03406942)))),0.24244434),max(var(tan(aul((x/x),aud(y,y)))),0.35932243)))));
    float b = pow((aul(y,min(var(x),y))-tan(aud((aud(y,y)-((cos(pow((var((x*0.439564))-pow(0.9996037,sin(y))),0.14476883))/0.8036873)+(y/(x-pow(y,0.88030744))))),aud(y,auh(y,tan((aul(x,y)/(y-x)))))))),sin(tan(pow(aul(sin(cos(min(cos(0.97517264),var(x)))),x),max(var(tan(aul((y/x),aud(y,x)))),x)))));
    return vec3(r,g,b);
}
