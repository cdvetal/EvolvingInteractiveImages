...
vec3 generateRGB(float x, float y){
    float r = sin(cos(aud(aud(tan(sin(x)),aud(tan(0.6780172),(tan(aud(0.44839454,tan((aud(x,x)-0.40733206))))*bri((y+(((0.5161409/x)-x)/0.70470214)),x)))),(x-y))));
    float g = sin(cos(aud(aud(tan(sin(y)),aud(tan(y),(tan(aud(y,tan((aud(0.49692017,0.78777355)-0.90604967))))*bri((0.50057995+(((y/x)-y)/0.38094628)),0.19568253)))),(x-y))));
    float b = sin(cos(aud(aud(tan(sin(x)),aud(tan(0.04040891),(tan(aud(x,tan((aud(x,x)-0.4095633))))*bri((x+(((0.7751228/0.9651321)-y)/0.07540673)),x)))),(0.14907825-x))));
    return vec3(r,g,b);
}
