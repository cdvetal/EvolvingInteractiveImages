...
vec3 generateRGB(float x, float y){
    float r = bri(y,audio(externalVal,bri(bri(externalVal,x),audio(audio(audio(y,audio(bri(audio(audio(externalVal,x),y),externalVal),y)),y),x))));
    float g = bri(audio(audio(audio(externalVal,x),x),audio(x,bri(y,bri(audio(externalVal,x),x)))),audio(y,externalVal));
    float b = bri(bri(y,audio(audio(bri(y,bri(x,bri(y,y))),y),bri(externalVal,audio(audio(x,externalVal),externalVal)))),externalVal);
    return vec3(r,g,b);
}
