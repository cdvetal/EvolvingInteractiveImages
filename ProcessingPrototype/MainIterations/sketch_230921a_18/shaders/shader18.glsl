...
vec3 generateRGB(float x, float y){
    ...
    float g = ((audio(externalVal,noise(externalVal,max(externalVal,(y+(max(mod(x,(audio(x,(externalVal-x))*mod(externalVal,y))),(externalVal/y))/cos(x))))))+externalVal)+externalVal);
