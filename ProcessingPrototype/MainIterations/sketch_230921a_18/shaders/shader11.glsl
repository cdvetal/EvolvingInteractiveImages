...
vec3 generateRGB(float x, float y){
    ...
    float g = noise(noise(externalVal,audio(x,tan(max((y*y),bri(y,noise(externalVal,x)))))),min((externalVal*x),(mod(mod(y,bri(((x+y)-max((y-(y+y)),max(externalVal,y))),externalVal)),externalVal)/x)));
