...
vec3 generateRGB(float x, float y){
    float r = pow(audio(pow(min(tan((0.5708284*y)),(audio(sin(cos(0.14986914)),x)+(tan(0.0)*cos(x)))),y),y),0.8510904);
    float g = pow(audio(pow(min(tan((externalVal*y)),(audio(sin(cos(externalVal)),externalVal)+(tan(y)*cos(y)))),x),y),externalVal);
    float b = pow(audio(pow(min(tan((y*0.89706475)),(audio(sin(cos(externalVal)),x)+(tan(y)*cos(0.8327615)))),0.92607105),0.58184516),0.56327754);
    return vec3(r,g,b);
}
