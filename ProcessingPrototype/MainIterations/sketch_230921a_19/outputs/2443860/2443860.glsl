...
vec3 generateRGB(float x, float y){
    float r = noise(noise(sin(x),0.6462513),(((tan(tan(((noise(y,x)/0.09376949)-x)))+0.9654154)-0.21446884)+0.42125058));
    float g = noise(noise(sin(x),externalVal),(((tan(tan(((noise(0.31605935,x)/y)-externalVal)))+externalVal)-externalVal)+y));
    float b = noise(noise(sin(externalVal),x),(((tan(tan(((noise(x,y)/0.06768417)-x)))+x)-externalVal)+y));
    return vec3(r,g,b);
}
